...
## The trip you take before the trip

Before the real trip there's this one, the one you take in your head, checking things you've already checked.

Let's do it properly. Ten minutes, starting now.

Nobody sees this work. Now it has a place to live, this trip and every one after.
...
The safest server for passport scans is no server at all, which is why the app keeps documents on your device and works fully offline by default. If you turn on backup, your encrypted vault goes to your own iCloud or Google Drive, sealed with a recovery code only you hold.
...
Here's an honest accounting of every piece of data in this app.

Your passport scans

On your device. With optional backup on, sealed in your own cloud before upload. I cannot see them either way.
...
Never transmitted to me. There's no Travel Document Vault server for them to reach.
...
## Plan trips, track allowances, sync to your own cloud

Built for families who travel everywhere.
...
Encrypted backup to your iCloud or Google Drive. You hold the recovery code. We never see it.
...
## For Travel. For Life. For Everything Important.

Built for families who travel. Essential for keeping track of every vital document, from insurance policies to work badges.

### Smart Reminders

Passport alerts start 8 months out
...
We watch the dates so you don't have to. Get gentle nudges months in advance, so renewal is a checklist item, not an emergency.

### Capture with Confidence

Streamlined capture. Our guides help you get a crisp, clear shot in seconds, so every number and face is readable.
...
Available in over 40 languages. The app feels native wherever you are.
...
Spotty airport Wi-Fi? No problem. Your documents are right there on your screen, whichever country you're in. Works fully offline in airplane mode.

### Respecting Your Privacy

We don't want your data. We don't sell ads. We just want to help you travel better.

[See all features](https://traveldocumentvault.com/features/) [Not sure? See why families are switching →](https://traveldocumentvault.com/why-us/)

## Simple, Honest Pricing

One-time purchase. No subscriptions. No hidden fees. No data harvesting.
...
- Days-abroad tracker for tax days and visa limits
- Country day-limit allowances per family member
- Every family member, one vault
- **Unlimited** documents
- Full family expiry dashboard
- Multi-page documents (up to 10 pages)
- Custom reminder timing
- Combined PDF export for printing
- Batch export documents

### Free

Everything you need for solo travel
...
Restore purchases anytime with the App Store or Google Play account you bought with.

[Full pricing details and FAQ](https://traveldocumentvault.com/pricing/)
