...
Store boarding passes and e-tickets with ultra-frequent countdown reminders.
...
Changed your mind after saving? Open any document in Edit mode to add new photos, remove old ones, or crop and rotate. Your vault stays accurate without starting over.

### Search & Filter

Find any document instantly by name or type. Filter by person, document type, or expiry status.

### Document Notes & Attachments

Add private notes and attach photos to any document. Store extra context, instructions, or visuals that don't fit in standard fields.

### Share with Ease

Every document has a built-in share button. Export as PDF or share the original file via email, messaging, or any app.

### Vouchers & Entry Tickets

Store gift cards, discount codes, event tickets, and attraction passes. Get expiry reminders so vouchers don't go to waste.
...
### Fine-Tune Every Scan

Fine-tune your captures with built-in editing tools:

- **Rotate**: 90° increments
- **Zoom preview**: pinch to check clarity
- **Resolution warnings**: if image is too small
- **Adjustable crop frame**: align with visual guides
...
8 months 6 months 3 months 6 weeks 1 month 2 weeks 1 week Expiry +1 day +1 week

#### Visa Reminders

3 months 6 weeks 1 month 2 weeks 1 week Expiry day +1 day +1 week
...
View documents and reminders filtered by person. See only what's relevant.

### Quick Switching

Switch between profiles with one tap. Perfect for managing the whole family.

### Unlimited Profiles

Pro

Free tier includes 1 profile. Pro unlocks unlimited profiles for the whole family.
...
Adapts to your system settings. Beautiful in both appearances.
...
Available in over 40 languages, so the app feels native wherever you are.
...
Choose your app accent from 10 presets or dial in any custom colour with the full colour picker. Available to all users, no Pro required.
...
No analytics. No ads. No hidden SDKs harvesting your data.
...
Protect your vault with a PIN. Available to all users for free.

### Biometric Lock

Unlock with Face ID or Touch ID instead of PIN. Free for all users. Requires PIN to be set up first.
...
Long-press any document card to instantly access quick actions: Export PDF, Share Original, or Delete. No need to open the document first.
