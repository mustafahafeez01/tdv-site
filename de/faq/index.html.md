...
Alles, was Sie über Travel Document Vault wissen müssen.

![Im App Store laden](https://traveldocumentvault.com/assets/images/app-store-badge-black.svg)

![Bei Google Play erhältlich](https://traveldocumentvault.com/assets/images/google-play-badge.svg) Einmalkauf · Kein Abo Springe zu: Datenschutz Funktionen Sicherung Preise Fehlerbehebung Recht

## Vertrauen & Transparenz

Kann der Entwickler meine Dokumente sehen?

Nein. Ihre Dokumente sind auf Ihrem Gerät gespeichert und verlassen es nie. Es gibt kein Kontosystem, keine Cloud-Datenbank und keinen Server, der Dokumentendaten empfängt. Die Architektur wurde von Anfang an so konzipiert – nicht nachträglich als Feature hinzugefügt.
...
Pro ist ein **Einmalkauf**, der unbegrenzte Profile, unbegrenzte Dokumente, kombinierten PDF-Export, verschlüsselte Sicherung und benutzerdefinierte Erinnerungszeiten freischaltet. Sie zahlen einmal - kein Abo, keine wiederkehrenden Kosten und keine Testversion, die still und heimlich mit der Abrechnung beginnt.

Sind zukünftige Updates in meinem Kauf enthalten?

Ja. Ihr Kauf umfasst alle Updates innerhalb der aktuellen Hauptversion (v1.x), einschließlich Fehlerbehebungen, Sicherheitspatches und neuer Funktionen. Verbesserungen durch Nutzerfeedback – wie Usability-Änderungen und neue Dokumenttypen – sind Teil dieser regulären Updates. Sollten wir jemals eine v2.0 mit grundlegend überarbeitetem Funktionsumfang veröffentlichen, könnte das ein separater Kauf sein, aber wir würden Frühadoptoren rechtzeitig informieren und Vorzugspreise anbieten. Menschen, die der App frühzeitig vertrauen, sind der Grund, warum sie besser wird – das nehmen wir nicht als selbstverständlich hin.
...
Ja, vollständig. Die App hat keinen Server und benötigt das Internet nicht zum Funktionieren. Scannen, Anzeigen, Exportieren und Erinnerungen funktionieren alle offline. Die einzige Funktion, die eine Verbindung erfordert, ist die Wiederherstellung Ihres Pro-Kaufs auf einem neuen Gerät über den App Store oder Google Play.

Welche Sprachen unterstützt die App?

Die App ist in über 40 Sprachen verfügbar, einschließlich vollständiger Unterstützung für von rechts nach links schreibende Sprachen wie Arabisch, Urdu und Farsi. Die Sprache Ihres Telefons wird automatisch erkannt und Sie können sie jederzeit in den Einstellungen ändern. Falls etwas in Ihrer Sprache merkwürdig aussieht, würden wir das gerne wissen. Schreiben Sie uns an [support@traveldocumentvault.com](mailto:support@traveldocumentvault.com) – das hat direkten Einfluss auf unsere Roadmap.
...
Travel Document Vault wurde von [Mustafa Hafeez](https://traveldocumentvault.com/de/blog/why-i-built-travel-document-vault/) entwickelt – einem Senior Software-Entwickler mit jahrelanger Berufserfahrung beim Aufbau datenschutzfreundlicher Anwendungen und einem Vater, der diese App für seine eigene Familie brauchte. Datenschutz ist kein Marketingslogan. Die App wurde von Anfang an so konzipiert und entwickelt, dass Dokumente das Gerät nie verlassen, keine Konten benötigt werden und keine Server beteiligt sind. Das ist eine bewusste technische Entscheidung – keine Richtlinie, die mit einem Einstellungsschalter geändert werden könnte.
...
Die App hat keine Cloud-Datenbank. Wir sehen Ihre Daten nicht. Wenn Sie **iCloud-Backup** (iOS) oder **Google-Backup** (Android) für Ihr gesamtes Telefon verwenden, sind die Daten dieser App in diesem Paket enthalten. **Ihre Daten bleiben innerhalb dieser Backups verschlüsselt.** Dieser Prozess wird von Ihrem Betriebssystem verwaltet, nicht von uns.

Kann ich meine Daten kostenlos sichern?

Ja. Der Tresor-Export (**.tdvault**-Datei) ist für alle kostenlos. Gehen Sie zu **Einstellungen, Tresor exportieren** und die App erstellt eine passwortgeschützte Datei, die Sie in der Dateien-App, iCloud Drive speichern oder per AirDrop teilen können. Die App erstellt außerdem automatisch **lokale Sicherungen alle paar Minuten** auf Ihrem Gerät, ohne Kosten. Die Cloud-Sicherung auf Ihrem eigenen iCloud oder Google Drive ist die Pro-Option. Keine Sicherungsfunktion sperrt Ihre Daten ein.

Was passiert, wenn ich mein Telefon verliere?

Da wir Ihre Daten nicht haben, können wir sie nicht für Sie wiederherstellen. Wenn Sie ein neues Telefon von einem System-Backup (iCloud/Google) wiederherstellen, sollten Ihre Daten wieder erscheinen. Wenn Sie keine System-Backups verwenden, gehen Ihre Daten verloren.

**Empfehlung:** Verwenden Sie die Export-Funktion, um eine Kopie Ihrer wichtigen Dokumente an anderer Stelle zu speichern.

Was, wenn jemand mein Telefon stiehlt? Sind meine Dokumente geschützt?
...
Können Sie auf meine Dokumente zugreifen?

**Nein.** Ihre Dokumente verlassen Ihr Gerät nie. Es gibt keine Server, keine Cloud-Synchronisierung und keine Uploads. Alles bleibt auf Ihrem Telefon, verschlüsselt und privat.

Da Ihre Daten unsere Server nie erreichen, haben wir keine Möglichkeit, auf Ihre Dokumente zuzugreifen, sie anzusehen oder wiederherzustellen. Das ist bewusst so gestaltet, um Ihre Privatsphäre zu schützen.
...
Erinnerungen werden automatisch gesendet und sind auf den Dokumenttyp abgestimmt. Ein Reisepass erhält die erste Erinnerung 8 Monate vor Ablauf (Passverlängerungen dauern üblicherweise 6-8 Wochen), danach folgen weitere bei 6 Monaten, 3 Monaten, 6 Wochen, 1 Monat, 2 Wochen und 1 Woche, sowie am Ablaufdatum selbst. Visa, nationale Ausweise und Reiseversicherungen erhalten die erste Erinnerung 3 Monate vor Ablauf. Auch wenn Sie den Termin verpassen, erinnern wir Sie **am Tag danach** und **eine Woche nach** Ablauf, um Ihnen den Start des Verlängerungsprozesses zu erleichtern. Flugtickets erhalten kürzere Abstände (1 Woche, 2 Tage, 1 Tag, 24 Stunden) und keine Erinnerungen nach Ablauf, da der Flug bereits abgeflogen ist.
...
Ja! Kostenlose Nutzer können einzelne Dokumente teilen. Pro-Nutzer erhalten leistungsstarke Stapelwerkzeuge: bestimmte Dokumente (oder alle Profile) auswählen und eine **einzelne kombinierte PDF** für den Druck erstellen. Sie können sogar benutzerdefinierte Dateinamen für Ihre Exporte festlegen, um Ihre digitalen Aufzeichnungen organisiert zu halten.
...
Die App verwendet **Profile**, um Dokumente nach Familienmitglied zu organisieren, aber alle Daten verbleiben auf Ihrem Gerät. Es gibt keinen gemeinsamen Zugriff oder eine Synchronisierung zwischen Geräten. Wenn Sie ein Dokument teilen müssen, können Sie es über das System-Teilen-Menü exportieren und per AirDrop, E-Mail oder Nachrichten senden.
...
**Wichtig: Vergessener PIN:** Wenn Sie Ihren PIN vergessen, ist der einzige Weg, wieder Zugang zu erhalten, die App zu löschen und neu zu installieren, was **alle Ihre Daten dauerhaft löscht**. Zum Schutz:

- Exportieren Sie ein verschlüsseltes Backup **bevor** Sie die App-Sperre aktivieren (Einstellungen → Tresor exportieren)
- Bewahren Sie Ihren PIN an einem sicheren Ort auf (z. B. im Passwort-Manager Ihres Geräts)
- Aktivieren Sie die **biometrische Entsperrung** (kostenlos für alle Nutzer), damit Sie Face ID, Touch ID oder Fingerabdruck statt PIN-Eingabe nutzen können
- Wenn Gerätesicherungen (iCloud/Google) aktiviert sind, kann die Wiederherstellung aus einem Backup Ihre Daten nach der Neuinstallation wiederherstellen
...
Halten Sie eine beliebige Dokumentkarte in Ihrer Liste gedrückt, um ein Schnellaktionsmenü zu öffnen. Von dort aus können Sie **PDF exportieren**, **Original teilen** oder das Dokument **löschen**, ohne es erst zu öffnen. Sie spüren ein leichtes haptisches Tippen, wenn das Menü erscheint. Dies funktioniert für alle Nutzer (Kostenlos und Pro).
...
Wann wird die Android-Version verfügbar sein?
...
Alle Käufe werden über den jeweiligen App Store abgewickelt. Für Rückerstattungen müssen Sie eine Anfrage bei Apple oder Google stellen. Bitte prüfen Sie Ihre Kaufbeleg-E-Mail für Anweisungen, wie Sie eine Rückerstattung aus dem Store anfordern können, wo Sie die App heruntergeladen haben.

## Fehlerbehebung

Ich erhalte keine Erinnerungsbenachrichtigungen

Stellen Sie sicher, dass Benachrichtigungen für Travel Document Vault in Ihren Geräteeinstellungen → Benachrichtigungen aktiviert sind. Vergewissern Sie sich auch, dass Sie Ihrem Dokument ein Ablaufdatum hinzugefügt haben. Erinnerungen werden nur geplant, wenn ein Ablaufdatum vorhanden ist.

OCR erkennt mein Ablaufdatum nicht

OCR funktioniert am besten bei guter Beleuchtung und einem flachen Dokument. Versuchen Sie, den Winkel oder die Beleuchtung anzupassen. Wenn die Erkennung fehlschlägt, können Sie das Ablaufdatum jederzeit manuell eingeben. OCR ist ein Hilfsmittel – es soll helfen, nicht die sorgfältige Dateneingabe ersetzen.
...
Wahrscheinlich nicht. Ihre Daten werden automatisch gespeichert, wenn Sie Dokumente hinzufügen oder bearbeiten. Ein Absturz sollte keinen Datenverlust verursachen. Öffnen Sie die App erneut und überprüfen Sie Ihre Dokumente. Wenn Sie Probleme feststellen, kontaktieren Sie uns bitte unter support@traveldocumentvault.com.

## Einrichtung und Wiederherstellung

Was ist mein Wiederherstellungscode und was passiert, wenn ich ihn verliere?

Ihr Wiederherstellungscode ist eine 24-stellige Passphrase, die Ihre Cloud-Sicherung verschlüsselt. Wenn Sie sie verlieren, werden diese Sicherungen nicht wiederherstellbar. Wir speichern oder setzen ihn nicht zurück. Vollständige Informationen über die Bedeutung, das Design-Konzept dahinter und was Sie tun können, wenn Sie ihn vergessen, erhalten Sie im Wiederherstellungscode-Handbuch.

[Vollständiges Handbuch →](https://traveldocumentvault.com/de/faq/recovery-code/)
...
Ist diese App ein Ersatz für offizielle Dokumente?

**Nein.** Travel Document Vault ist ausschließlich ein persönliches Organisationstool. Es ersetzt keine offiziellen Dokumente, überprüft keine Authentizität und garantiert keine Einhaltung von Einwanderungsanforderungen. Führen Sie stets Ihre Originaldokumente bei Reisen mit und überprüfen Sie Anforderungen bei offiziellen Regierungsstellen.

Was, wenn ich eine Frist wegen eines Erinnerungsfehlers verpasse?
...
Wir helfen gerne weiter. Schreiben Sie uns und wir melden uns so schnell wie möglich.

[Support kontaktieren](mailto:support@traveldocumentvault.com)
