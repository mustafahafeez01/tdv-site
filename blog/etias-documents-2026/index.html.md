...
![A passport on a royal navy background with a loose arc of gold stars and faint dotted route lines, evoking European travel](https://traveldocumentvault.com/blog/etias-documents-2026/cover.jpg)
...
**ETIAS affects** individual travellers, families with multiple members applying separately, digital nomads planning repeated short stays, and anyone booking European trips for late 2026 onwards - and remember that each person between 18 and 70 in your family needs their own individual ETIAS application.
...
ETIAS will ask for **security and personal information** - your full name, date of birth, place of birth, nationality, and contact details - alongside questions about any criminal convictions or previous visa overstays. Honesty is absolutely critical at this stage, because false information is grounds for permanent rejection and can trigger deportation bans.

Though optional, submitting **proof of income** - such as recent pay slips, bank statements, or tax returns - is worth considering, as the European Commission doesn't mandate it universally but providing evidence of financial stability can strengthen borderline applications and meaningfully reduce rejection risk.
...
Next, you'll answer security questions covering criminal history, previous deportations, visa overstays, and involvement in terrorism or extremism - questions designed explicitly to catch security risks. If you need to answer "yes" to any of these, the optional notes section is where a good explanation can help; for instance, if you were previously refused a visa due to a misunderstanding, a brief clarification can shift the outcome.

Health declarations are straightforward - you'll be asked if you have infectious diseases or serious conditions that pose a public health risk, which differs from travel insurance medical requirements since ETIAS is focused specifically on disease control rather than individual health status.

At the end, you review your information, pay the €20 fee (free if under 18 or over 70), and submit - at which point a confirmation number is generated immediately and your application enters the processing queue.
...
A **rejection** typically stems from incomplete or inconsistent information - missing travel dates, conflicting employment history, or unclear answers all trigger this outcome. The good news is you can reapply immediately to fix the issue with no waiting period, since these are easily correctable mistakes.

A **refusal to authorise** is more serious, occurring when ETIAS security checks uncover criminal convictions, previous Schengen overstays, or other security concerns. Whilst you can technically reapply immediately if your circumstances change, successful reapplication is unlikely if the refusal was security-based, so you'll generally need to apply for a long-stay visa through an embassy instead - visa-exempt travel to Schengen countries is off the table once you've been refused.
...
**Undisclosed criminal convictions:** If you have a criminal record and don't disclose it but ETIAS finds it during a background check, your application is refused rather than rejected - a meaningful distinction. Always disclose, even if the conviction is old or has been expunged in your home country, because European authorities may still retain records. A security-based refusal is extremely difficult to overturn unless your circumstances change dramatically.

**Previous overstays:** If you've overstayed a visa in Europe or elsewhere, ETIAS will certainly flag it, so come prepared with a brief explanation in the optional notes field - something like "Emergency family matter delayed departure; resolved with authorities" can help your case, though some overstays trigger refusal regardless of justification.

**Conflicting travel history:** ETIAS will detect inconsistencies like claiming a 10-day trip to France when your entry and exit dates suggest a 20-day stay, so if you don't remember exact dates, it's better to estimate conservatively or explicitly note that you're approximating rather than risk a contradiction.

**Unclear employment or income:** Flag any gaps or inconsistencies - for instance, if you claim employment but your travel dates suggest you were working abroad without saying so, or if your employment history has unexplained gaps - by using the optional notes section to clarify. ETIAS won't reject you for being unemployed, but unexplained inconsistencies will raise suspicion.

To avoid rejection, review your information carefully three times before submitting, and if anything is uncertain, use the optional notes field to explain - a brief, honest explanation will prevent rejections far more effectively than attempting to hide information.

## Special Cases: Children, Family Groups, and Re-entry After Refusal

Children under 18 don't pay the ETIAS fee but should still apply for authorisation, with parents applying on their behalf - though as a future enhancement, biometric checks at the border may eventually require children to be present in person.
...
[Family Docs8 min read · Jan 18Child Travel Consent Letter: What You Need](https://traveldocumentvault.com/blog/child-travel-consent-letter/)

[Visas & Entry6 min read · Jul 7, 2026Your 90-Day Schengen Window: Counting Days in the EES Era](https://traveldocumentvault.com/blog/schengen-90-days-auto-tracked-ees/)
