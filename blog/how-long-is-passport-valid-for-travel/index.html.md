# How Long is a Passport Valid for Travel? Validity Rules Explained

> Most adult passports are valid for 10 years, but your travel window is often shorter. Learn how passport validity months work and when to renew.

Source: https://traveldocumentvault.com/blog/how-long-is-passport-valid-for-travel/

---

![A single premium passport standing upright on a royal navy background, cream cover with an embossed globe and gold page edges](https://traveldocumentvault.com/blog/how-long-is-passport-valid-for-travel/cover.jpg)
...
- Popular destinations including Thailand, Turkey, Vietnam, and Indonesia generally require **at least 6 months of validity on the day you arrive** - and some countries count from your departure date, so check each destination.
...
Seven months left on your passport sounds like plenty. You book the flights, check the baggage allowance, start looking at hotels. Then you get to the check-in desk for your flight to Bangkok and the agent pauses: Thailand requires your passport to be valid for at least 6 months on the day you arrive, and you are two weeks short. You are not boarding.

It is one of the most commonly misunderstood rules in travel, because a passport that has not expired can still fail the entry requirements for dozens of popular destinations. Understanding how passport validity months are actually counted can save you a very expensive mistake.
...
![Hand-drawn timeline comparing passport validity: an adult passport runs 10 years, a child passport only 5, and a 6-month buffer zone sits at the end of both because many countries require it](https://traveldocumentvault.com/blog/how-long-is-passport-valid-for-travel/passport-validity-timeline.jpg) Two clocks, one catch - the 6-month buffer many countries expect before your expiry date.
...
This is where families get caught out every summer: adult passports run for 10 years, child passports for only 5, and that gap creates a specific problem.
...
To most European destinations, yes - your passport just needs to be valid for the duration of your stay. For destinations that enforce the 6-month rule, including Thailand, Turkey, Vietnam, and Indonesia, those 6 months are generally counted from the day you arrive - though some countries count from departure. Check the specific requirement for your destination and nationality before booking.
