# Can You Travel with a Damaged Passport? What Agents Check

> Most wear passes. Staff check the data page, the machine-readable strip and whether the booklet holds together. What to do if yours is in doubt.

Source: https://traveldocumentvault.com/blog/damaged-passport-travel/

---

![parent and child at an airline check-in desk while the agent studies an open gold passport with water-damaged pages](https://traveldocumentvault.com/blog/damaged-passport-travel/cover.jpg)
...
![Two open passports side by side: one worn but flat and usable, one water-stained with rippled pages and lifting lamination](https://traveldocumentvault.com/blog/damaged-passport-travel/damage-vs-wear-figure.jpg) Minor creases on the cover: acceptable. Water damage to the data page: a problem.
