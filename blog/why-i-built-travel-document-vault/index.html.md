...
![A neat stack of a family's passports with a boarding pass tucked in, resting on a deep navy background](https://traveldocumentvault.com/blog/why-i-built-travel-document-vault/cover.jpg)
...
I tried cloud storage - great for files, useless for tracking expiry dates, because I still had to open every document and do the mental math myself.

I tried calendar reminders too - set a notification six months before each passport expired, but the scans lived in one place and the reminders in another, so when I needed to check something at 11pm before booking a flight, I was bouncing between three apps trying to piece it all together.

Some people swear by password managers for document scans, but they're built for passwords, not expiry dates, and they definitely don't warn you when your kid's passport is about to derail a trip.
...
![Hand-drawn diagram of five scattered apps - photos, cloud, notes, email, calendar - converging into one vault, which gives back expiry reminders, encryption and offline access: one app instead of five](https://traveldocumentvault.com/blog/why-i-built-travel-document-vault/scattered-to-single-vault.jpg) What the 11pm check used to involve - and what it involves now.

## It's not just passports

Once I started using it, I noticed how many other documents quietly expire in the background.

Work permits if you're living abroad, visas and residency cards needing annual renewal, driver's licences, health insurance, travel insurance, national IDs for the kids.

Each has an expiry date. Each matters at exactly the wrong moment. Nobody reminds you until you're standing at the embassy realising your visa expired last month.
