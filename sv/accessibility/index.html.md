...
> Travel Document Vault är byggd för alla. Läs om våra VoiceOver-, dynamisk text-, mörkt läge- och minskad rörelse-funktioner. AES-256-GCM-krypterad, offline och privat utan prenumeration.
...
- Felindikatorer med kryss-ikoner (inte bara röd färg)
...
## Ytterligare tillgänglighetsöverväganden
...
Tillgänglighet är ett pågående åtagande. Om du stöter på hinder när du använder Travel Document Vault, eller har förbättringsförslag, är du välkommen att höra av dig.

[Skicka tillgänglighetskommentar](mailto:support@traveldocumentvault.com?subject=Tillg%C3%A4nglighetskommentar)
