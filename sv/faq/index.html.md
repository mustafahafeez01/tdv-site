...
Allt du behöver veta om Travel Document Vault.

![Ladda ned på App Store](https://traveldocumentvault.com/assets/images/app-store-badge-black.svg)

![Hämta på Google Play](https://traveldocumentvault.com/assets/images/google-play-badge.svg) Engångsköp · Ingen prenumeration Hoppa till: Integritet Funktioner Säkerhetskopia Priser Felsökning Juridik
...
Ja. Ditt köp täcker alla uppdateringar inom den aktuella huvudversionen (v1.x), inklusive buggfixar, säkerhetspatchar och nya funktioner. Förbättringar drivna av användarfeedback, som användbarhetsändringar och nya dokumenttyper, ingår i dessa normala uppdateringar. Om vi någonsin släpper en v2.0 med ett väsentligt ombyggt funktionsset kan det kräva ett separat köp, men vi skulle ge tidiga användare förhandsbesked och förmånlig prissättning. Människor som litar på appen tidigt är anledningen till att den blir bättre, och det är något vi inte tar för givet.

Vad händer om jag tappar bort min telefon eller byter till en ny?

Eftersom vi inte lagrar din data kan vi inte återställa den åt dig. Om du återställer din nya telefon från en iCloud- eller Google-säkerhetskopia bör dina dokument följa med automatiskt. Vi rekommenderar att du använder exportfunktionen för att hålla en separat kopia av dina viktiga dokument, för säkerhets skull.
...
Appen är tillgänglig på över 40 språk, inklusive full höger-till-vänster-stöd för arabiska, urdu och farsi. Telefonens språk detekteras automatiskt, och du kan ändra det när som helst i Inställningar. Om något låter konstigt på ditt språk vill vi genuint veta det. Skicka ett mail till [support@traveldocumentvault.com](mailto:support@traveldocumentvault.com) så påverkar det direkt vår färdplan.
...
Appen har ingen molndatabas. Vi ser inte din data. Om du använder **iCloud Backup** (iOS) eller **Google Backup** (Android) för hela din telefon installeras appen om på en ny enhet, men dina dokument hämtas INTE automatiskt. Din krypteringsnyckel lämnade aldrig din ursprungliga enhet, så vi kan inte dekryptera dem på din nya telefon. **Gratis Vault Export är ditt verktyg för att spara en separat kopia.** Pro-användare kan också skapa krypterad säkerhetskopia till sitt eget iCloud eller Google Drive med en återställningskod endast de har.

Kan jag säkerhetskopiera min data gratis?

Ja. Vault Export (krypterad .tdvault-säkerhetskopieringsfil) är gratis för alla. Appen skapar också automatiska lokala säkerhetskopior på din enhet med några minuters mellanrum, utan kostnad. Molnsäkerhetskopiering till ditt eget iCloud eller Google Drive är Pro-alternativet. Ingen säkerhetskopieringsfunktion låser in din data.
...
Vad händer om någon stjäl min telefon? Är mina dokument skyddade?
...
Kan ni komma åt mina dokument?

**Nej.** Dina dokument lämnar aldrig din enhet. Det finns inga servrar, ingen molnsynk och inga uppladdningar. Allt stannar på din telefon, krypterat och privat.

Eftersom din data aldrig når våra servrar har vi inget sätt att komma åt, visa eller återställa dina dokument. Detta är avsiktligt för att skydda din integritet.

Är säkerhetskopior också krypterade?

**Ja.** Automatiska säkerhetskopior krypteras via enhetens inbyggda säkerhetskopieringssystem (iCloud/Google). Vault-exporter (.tdvault-filer) är **lösenordsskyddade** med stark kryptering. Du anger ett lösenord vid exporten och behöver det för att återställa.

Om du återställer från en säkerhetskopia fungerar dina dokument automatiskt på din nya enhet utan att du behöver göra något speciellt.
...
Påminnelser startar automatiskt, tidsanpassade för dokumenttypen. Ett pass börjar 8 månader innan utgångsdatum (förnyelse tar vanligtvis 6-8 veckor), sedan stegar ned genom 6 månader, 3 månader, 6 veckor, 1 månad, 2 veckor och 1 vecka, och återigen på utgångsdagen. Visum, nationella ID:n och reseförsäkring börjar 3 månader innan. Även om du missar datumet påminner vi dig **dagen efter** och **en vecka efter** utgångsdatum för att hjälpa dig börja förnyelsen. Flygbiljetter får ett tätare schema istället (1 vecka, 2 dagar, 1 dag, 24 timmar) och inga påminnelser efter utgångsdatum, eftersom flyget redan har gått.
...
Appen lagrar allt på din enhet. Om du har iCloud (iOS) eller Google Backup (Android) aktiverat är dina dokument redan skyddade via enhetens säkerhetskopia. Pro-användare kan exportera en **lösenordsskyddad krypterad säkerhetskopia** för förvaring, och alla användare kan **återställa från en säkerhetskopia** när som helst via Inställningar → Importera valv. Detta ersätter all aktuell data med säkerhetskopians innehåll. Vi synkroniserar avsiktligt inte till våra servrar för att skydda din integritet.

Kan jag dela dokument med familjemedlemmar?

Appen använder **profiler** för att organisera dokument per familjemedlem, men all data stannar på din enhet. Det finns ingen delad åtkomst eller synk mellan enheter. Om du behöver dela ett dokument kan du exportera det via systemets delningsblad och skicka det via AirDrop, e-post eller meddelanden.
...
**Viktigt: Glömt PIN:** Om du glömmer din PIN är det enda sättet att återfå åtkomst att radera och installera om appen, vilket **permanent raderar all din data**. För att skydda dig:

- Exportera en krypterad säkerhetskopia **innan** du aktiverar App-lås (Inställningar → Exportera valv)
- Spara din PIN på ett säkert ställe (t.ex. enhetens lösenordshanterare)
- Aktivera **biometrisk upplåsning** (gratis för alla användare) så att du kan använda Face ID, Touch ID eller fingeravtryck istället för PIN
- Om du har enhetssäkerhetskopior (iCloud/Google) aktiverade kan det vara möjligt att återställa din data via en säkerhetskopia efter ominstallation
...
**Gratisanvändare:** Får smarta standardvärden valda efter dokumenttypen. Pass startar 8 månader innan, visum och ID:n 3 månader innan, biljetter och bokningar en vecka innan, och var och en stegar ned automatiskt till utgångsdatum.

**Pro-användare:** Kan ändra startpunkten för vilket dokument som helst. Välj 8 månader, 6 månader, 3 månader, 6 veckor, 1 månad, 2 veckor, 1 vecka eller utgångsdagen, och resten av schemat fylls i automatiskt. Flygbiljetter har sina egna alternativ: 1 vecka, 2 dagar, 1 dag eller 24 timmar.

För att anpassa påminnelser, tryck på ett dokument → Redigera → Påminnelsesektion (endast Pro).
...
Håll in (tryck och håll) på ett dokumentkort i listan för att öppna en snabbåtgärdsmeny. Därifrån kan du **Exportera PDF**, **Dela original** eller **Radera** dokumentet utan att öppna det först. Du känner ett subtilt haptikknackande när menyn visas. Detta fungerar för alla användare (Gratis och Pro).
...
Alla dokumentkort färgkodas automatiskt. **Grönt** betyder giltigt, **gult** betyder utgångsdatum närmar sig, och **rött** betyder utgånget eller utgår inom kort. Du kan se statusen för ditt hela valv på ett ögonkast utan att öppna ett enda dokument.

**Pro-användare** kan gå längre: åsidosätt färgen per dokumenttyp från fliken för profilinställningar. Tilldela en distinkt färg till pass, visum eller någon kategori du vill att ska stå ut. Detta staplas på statusfärgerna, så du alltid ser både kategorin och brådskandet på en gång.

Kan jag bifoga foton till mina anteckningar?

Ja. Anteckningar och Vouchers stödjer flera bifogade bilder. Gratisanvändare kan bifoga en bild per anteckning. **Pro-användare kan bifoga upp till 10.** Bifoga ett foto av ett bekräftelsemedalande, en QR-kod, en bokningsreferens eller vad som helst som ger sammanhang. Varje bild är krypterad på enheten, precis som resten av ditt valv.

## Plattform och kompatibilitet

När blir Android-versionen tillgänglig?
...
**Ja.** Pro är ett engångsköp för den **aktuella huvudversionen** (v1.x). Du får alla buggfixar, säkerhetsuppdateringar och funktionstillägg gratis inom den versionen.

Om vi i framtiden släpper en version 2.0 med betydande nya funktioner kan det kräva ett separat uppgraderingsköp. Vi ger förhandsbesked och early bird-priser till befintliga Pro-användare. Denna policy säkerställer att vi kan fortsätta förbättra appen med ett prisvärt utgångspris.

Läs mer i vår [Prispolicy](https://traveldocumentvault.com/pricing-policy/).

Vad betyder "alla v1.x-uppdateringar ingår"?

Ditt köp på $9.99 täcker alla uppdateringar inom den aktuella huvudversionen, det innebär alla buggfixar, säkerhetspatchar och nya funktioner som släpps som v1.1, v1.2, v1.3 och så vidare. Din app fortsätter att fungera och förbättras utan extra kostnad.

Om en framtida huvudversion (v2.0) någonsin släpps med ett väsentligt ombyggt funktionsset kan den erbjudas som ett separat köp. Du tvingas aldrig uppgradera, din nuvarande version fortsätter att fungera precis som den gör idag. Se vår [fullständiga versionspolicy](https://traveldocumentvault.com/pricing-policy/#version-policy) för detaljer.

Hur begär jag återbetalning?

Alla köp behandlas via respektive App Store. För återbetalning behöver du begära det via Apple eller Google. Kontrollera ditt köpkvitto för instruktioner om hur du begär återbetalning från butiken där du laddade ned appen.

## Felsökning

Jag får inga påminnelsenotiser

Kontrollera att aviseringar är aktiverade för Travel Document Vault i enhetens Inställningar → Aviseringar. Se också till att du har lagt till ett utgångsdatum i ditt dokument. Påminnelser schemaläggs bara när det finns ett utgångsdatum.

OCR detekterar inte mitt utgångsdatum

OCR fungerar bäst med bra belysning och ett platt dokument. Försök justera vinkeln eller belysningen. Om detekteringen misslyckas kan du alltid ange utgångsdatumet manuellt. OCR är ett hjälpmedel. Det är designat för att hjälpa, inte ersätta noggrann datainmatning.
...
Förmodligen inte. Din data sparas automatiskt när du lägger till eller redigerar dokument. En krasch bör inte orsaka dataförlust. Öppna appen igen och kontrollera dina dokument. Om du ser problem, kontakta oss på support@traveldocumentvault.com.

## Konfiguration och återställning

Vad är min återställningskod och vad händer om jag förlorar den?

Din återställningskod är en 24-teckens lösenfras som krypterar din molnsäkerhetskopia.

Hur krypteras min molnsäkerhetskopia?

Ditt valv är krypterat från slutet till slut med AES-256-GCM på din enhet.

[Läs hela guiden →](https://traveldocumentvault.com/sv/faq/backup-explained/)

Hur fungerar PIN, Face ID och återställningskod tillsammans?

Din PIN är ett dagligt lås. Face ID är en snabb genväg för att låsa upp.

[Läs hela guiden →](https://traveldocumentvault.com/sv/faq/recovery-code/)
...
Borttagna objekt går till papperskorgen i 30 dagar.

## Juridik och ansvarsfriskrivningar

Ersätter den här appen officiella dokument?

**Nej.** Travel Document Vault är enbart ett personligt organiseringsverktyg. Det ersätter inte officiella handlingar, verifierar äkthet eller garanterar efterlevnad av immigrationskrav. Bär alltid originalhandlingar när du reser och verifiera krav hos officiella statliga källor.

Vad händer om jag missar en deadline på grund av en påminnelsefel?
...
Vi hjälper gärna till. Hör av dig så återkommer vi så snart som möjligt.

[Kontakta support](mailto:support@traveldocumentvault.com)
