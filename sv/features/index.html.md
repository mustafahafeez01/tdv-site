# Funktioner - Skanna och spåra

> Skanna pass, lagra visum och ID. Utgångspåminnelser, reseplanering, spåra dagar per land och krypterad säkerhetskopia. Offline-åtkomst, privat.

Source: https://traveldocumentvault.com/sv/features/
...
Fotografera fram- och baksida i ett enda dokument. Perfekt för körkort, nationella ID-kort och arbetsbrickor.
...
Spara boardingkort och e-biljetter med mycket frekventa nedräkningspåminnelser.
...
Ångrat dig efter att ha sparat? Öppna vilket dokument som helst i redigeringsläge för att lägga till nya foton, ta bort gamla, eller beskära och rotera. Ditt valv förblir korrekt utan att börja om.

### Sök och filtrera

Hitta vilket dokument som helst direkt via namn eller typ. Filtrera efter person, dokumenttyp eller utgångsstatus.

### Dokumentanteckningar

Pro

Lägg till privata anteckningar till vilket dokument som helst. Spara extra detaljer, instruktioner eller påminnelser som inte passar i standardfälten.

### Dela enkelt

Pro

Varje dokument har en inbyggd delningsknapp. Exportera som PDF eller dela originalfilen (foto eller importerat dokument) via e-post, meddelanden eller valfri app.

### Voucher och inträdesbiljetter

Pro

Spara presentkort, rabattkoder, evenemangsbiljetter och attraktion-pass. Få påminnelser om utgångsdatum så att voucher inte går till spillo. Importera flersidiga PDF:er med Pro.
...
Guider på skärmen hjälper dig att justera dina dokument exakt. Olika mallar för olika dokumenttyper:

- **Pass**: med mittlinje för öppna uppslag
- **ID-kort**: ram i kreditkortsstorlek
- **Visum/tillstånd**: A5/halvsidesguide för stämplar och klistermärken
- **Helsida**: A4-guide för e-visum, försäkring och biljetter

### Finjustera varje skanning

Finjustera dina skanningar med inbyggda redigeringsverktyg:

- **Rotera**: i steg om 90°
- **Zoomförhandsvisning**: nyp för att kontrollera skärpa
- **Upplösningsvarningar**: om bilden är för liten
- **Justerbar beskärningsram**: justera med visuella guider
...
8 månader 6 månader 3 månader 6 veckor 1 månad 2 veckor 1 vecka Utgångsdatum +1 dag +1 vecka

#### Visumpåminnelser

3 månader 6 veckor 1 månad 2 veckor 1 vecka Utgångsdagen +1 dag +1 vecka
...
Visa dokument och påminnelser filtrerade per person. Se bara det som är relevant.

### Snabbväxling

Byt mellan profiler med ett tryck. Perfekt för att hantera hela familjen.

PRO

### Obegränsat antal profiler

Gratisnivån inkluderar 1 profil. Pro låser upp obegränsat antal profiler för hela familjen.
...
Anpassar sig till dina systeminställningar. Vacker i båda utseendena.
...
Tillgänglig på över 40 språk så att appen känns naturlig var du än är.
...
Ingen analys. Inga annonser. Inga dolda SDK:er som skördar din data.
...
Skydda ditt valv med en PIN-kod. Tillgängligt för alla användare gratis.

### Biometriskt lås

Lås upp med Face ID eller Touch ID istället för PIN. Gratis för alla användare. Kräver att PIN är konfigurerad först.
...
## Hantera flera dokument på en gång

### Snabbmeny vid lång tryckning

Håll in på ett dokumentkort för att direkt komma åt snabbåtgärder: Exportera PDF, Dela original eller Radera. Behöver inte öppna dokumentet först.
...
## Ladda ned gratis. Ingen prenumeration.

Konfigurera det ikväll. Låt appen komma ihåg så att du slipper.
