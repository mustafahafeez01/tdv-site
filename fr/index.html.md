# Travel Document Vault | Un souci de moins

> Stockez passeports et visas en toute sécurité. Rappels d'expiration, accès hors ligne, chiffrement E2E. Pas de comptes, pas de serveurs.

Source: https://traveldocumentvault.com/fr/

---

09:41

## Le voyage que vous faites avant le voyage

Avant le vrai voyage, il y a celui-là, celui que vous faites dans votre tête, à revérifier ce que vous avez déjà vérifié.

Faisons-le bien. Dix minutes, à partir de maintenant.

Personne ne voit ce travail. Ce soir, vous lui avez donné une place, pour ce voyage et pour tous les suivants.
...
Il n'y a pas de financement par capital-risque qui me pousse à vendre vos données et aucune feuille de route motivée par des métriques de croissance. C'est simplement un outil qui résout un problème, correctement.

### Conception Hors Ligne

Le serveur le plus sûr pour les scans de passeport n'existe pas du tout. C'est pourquoi l'application conserve les documents sur votre appareil et fonctionne complètement hors ligne par défaut. Si vous activez une sauvegarde, votre coffre-fort chiffré va vers votre propre iCloud ou Google Drive, scellé avec un code de récupération que vous seul avez.
...
Voici un compte rendu honnête de chaque donnée dans cette application.

Vos scans de passeport

Stockés sur votre appareil uniquement. Je ne peux pas les voir.
...
Jamais transmis à moi. Il n'y a pas de serveur Travel Document Vault pour qu'ils atteignent.
...
Sauvegarde chiffrée dans votre iCloud ou Google Drive. Vous détenez le code de récupération. Nous ne le voyons jamais.
...
Conçu pour les familles qui voyagent. Essentiel pour suivre tous les documents vitaux, des polices d'assurance aux insignes professionnels.

### Rappels Intelligents

Alertes passeport dès 8 mois avant
...
Disponible en plus de 40 langues. L'application s'intègre naturellement, où que vous soyez.
...
Nous observons les dates pour que vous n'ayez pas à le faire. Recevez des rappels discrets des mois à l'avance, pour que le renouvellement soit une tâche à cocher et non une urgence.

### Capturer en Confiance

Capture rationalisée. Nos guides vous aident à obtenir une photo nette et claire en quelques secondes, afin que chaque numéro et visage soit lisible.

### Votre Vie, Organisée

Passeports, permis de conduire, assurance. Stockés de manière sécurisée, strictement privés et suivis pour expiration. Un endroit pour tout ce qui compte.

### Parle Votre Langue

Disponible en plus de 40 langues. L'application s'intègre naturellement, où que vous soyez.

Anglais, Español, Français, Deutsch, Italiano, Português (BR), Português (PT), Русский, 中文 (简体), 日本語, 한국어, Nederlands, Indonesia, ไทย, Українська
...
Wi-Fi instable à l'aéroport ? Pas de problème. Vos documents sont juste là sur votre écran, quel que soit le pays dans lequel vous vous trouvez. Fonctionne sans problème en mode avion.

### Respect de votre vie privée

Nous ne voulons pas vos données. Nous ne vendons pas d'annonces. Nous voulons juste vous aider à voyager mieux.

[Voir toutes les fonctionnalités](https://traveldocumentvault.com/fr/features/) [Pas sûr ? Voir pourquoi les familles changent →](https://traveldocumentvault.com/fr/why-us/)
...
[Tous les détails de tarification et FAQ](https://traveldocumentvault.com/fr/pricing/)
