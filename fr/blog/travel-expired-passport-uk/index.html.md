...
![Un seul passeport crème fermé, posé à plat sur un fond bleu marine royal, prêt à être vérifié avant le voyage](https://traveldocumentvault.com/blog/travel-expired-passport-uk/cover.jpg)

## Points clés

- **Règle absolue :** Pas de voyages internationaux avec un passeport expiré. Les compagnies aériennes et le contrôle aux frontières vous refuseront.
- **Exceptions nationales :** Royaume-Uni vers l'Irlande et Île de Man peuvent accepter une pièce d'identité avec photo alternative. Contactez d'abord votre compagnie aérienne.
- **Renouvellement d'urgence :** Service Premium en ligne disponible pour £239,50 au total (rendez-vous le même jour ou le lendemain, renouvellements uniquement).
...
Ce qui suit explique comment cela se déroule en pratique : vos options limitées, pourquoi le temps est si crucial, et quoi faire pour éviter la panique à l'enregistrement.
...
**Ce n'est pas une permission de sauter le renouvellement de passeport.** Différentes compagnies aériennes ont différentes politiques sur les trajets domestiques : certaines exigent un passeport pour tous les voyages vers l'Irlande même si la Zone de voyage commun autorise techniquement les voyages avec carte d'identité, tandis que d'autres acceptent un permis de conduire. Les compagnies aériennes mettent à jour leurs règles, et votre transporteur a peut-être changé les siennes depuis que vous avez volé pour la dernière fois, donc vous ne pouvez pas supposer ce qui a fonctionné avant.

Si vous envisagez un voyage domestique avec un passeport expiré, contactez votre compagnie aérienne au moins 48 heures avant votre vol et demandez explicitement : « Mon passeport britannique est expiré. Allez-vous accepter mon permis de conduire britannique à la place ? » Obtenez une confirmation écrite si vous pouvez, car arriver à l'enregistrement avec une pièce d'identité alternative et sans confirmation préalable est comme rater des vols.
...
Le processus est lent et bureaucratique. Vous devrez fournir une preuve d'identité et payer les frais, actuellement £125. La plupart des ambassades prennent plusieurs jours pour émettre le document, bien que certains puissent le faire en 24-48 heures si vous êtes véritablement coincé. D'autres prennent une semaine. Le document d'urgence n'est pas un passeport touristique - il n'est valide que pour le voyage spécifique de retour au Royaume-Uni sans autoriser de voyages ultérieurs.
...
### Puis-je voyager avec un passeport expiré si j'ai un visa ?
...
Pas par la voie standard du Bureau des passeports du Royaume-Uni. Si vous êtes à l'étranger et votre passeport expire, vous devez contacter l'ambassade ou le consulat britannique le plus proche. Ils gèrent les documents de voyage d'urgence, pas le bureau de passeport principal.
...
[Renouvellement de passeport5 min de lecture · 9 mars 2026Passeport expiré ? Voici exactement quoi faire (étape par étape)](https://traveldocumentvault.com/fr/blog/passport-expired-what-to-do/)
