...
旅券の身分事項ページには、二つの日付が同じ書式で上下に並んでいます。どちらにも分かりやすい表示はありません。入国申請、航空会社の書式、査証の申請サイトは、それぞれこのうちの特定の一方を求めます。どちらを求められるかは、何を記入しているかによって決まります。
...
ページ下部にある2行の文字とシェブロン記号の並びは、機械読み取り部分(MRZ)です。ここには上のページの情報の一部が、スキャナーが一度で読み取れる書式で記載されていますが、すべてではありません。有効期限は含まれていますが、発行日は含まれていません。だからこそこの部分の損傷は、表紙のこすり傷などよりもはるかに深刻に扱われます。この境界線については、[損傷したパスポートでの渡航](https://traveldocumentvault.com/ja/blog/damaged-passport-travel/)で詳しく解説しています。
