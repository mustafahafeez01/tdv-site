...
## Il Viaggio che si Fa Prima del Viaggio

Prima del vero viaggio c'è questo: quello che fa nella Sua mente, ricontrollando cose che ha già controllato.

Lo faccia per bene. Dieci minuti, a partire da adesso.

Nessuno vede questo lavoro. Ora ha un posto dove stare, per questo viaggio e per tutti quelli dopo.
...
Il server più sicuro per le scansioni dei passaporti è nessun server, ecco perché l'app conserva i documenti sul Suo dispositivo e funziona completamente offline per impostazione predefinita. Se attiva il backup, il Suo caveau crittografato va al Suo iCloud o Google Drive, sigillato con un codice di recupero che solo Lei possiede.
...
Ecco un conto onesto di ogni dato in questa app.

Le Sue scansioni dei passaporti

Archiviate solo sul Suo dispositivo. Non posso vederle.
...
Mai trasmessi a me. Non c'è un server Travel Document Vault per raggiungerli.
...
## Pianificate i viaggi, monitorate le franchigie, sincronizzate sul vostro cloud

Realizzato per le famiglie che viaggiano ovunque.
...
Backup crittografato nel Suo iCloud o Google Drive. Lei detiene il codice di ripristino. Non lo vediamo mai.
...
Aggiungete un profilo per ogni membro della famiglia. Piano gratuito: 1 profilo; Pro sblocca profili illimitati.

## Per Viaggi. Per la Vita. Per Tutto Ciò che è Importante.

Costruito per famiglie che viaggiano. Essenziale per tracciare ogni documento vitale, dalle polizze assicurative ai badge di lavoro.

### Promemoria Intelligenti

Avvisi passaporto da 8 mesi prima
...
Controlliamo le date per Lei. Riceva piccoli suggerimenti mesi in anticipo, in modo che il rinnovo sia una voce della lista di controllo, non un'emergenza.

### Cattura con Fiducia

Cattura semplificata. Le nostre guide La aiutano a fare una foto nitida e chiara in pochi secondi, in modo che ogni numero e volto sia leggibile.

### La Sua Vita, Organizzata

Passaporti, patenti, assicurazioni. Conservati in modo sicuro, strettamente privati e tracciati per la scadenza. Un unico posto per tutto ciò che conta.

### Parla la Sua Lingua

Disponibile in oltre 40 lingue. L'app sembra nativa ovunque Lei si trovi.
...
WiFi instabile in aeroporto? Nessun problema. I Suoi documenti sono proprio lì sullo schermo, in qualsiasi paese Lei si trovi. Funziona perfettamente in modalità aereo.

### Rispettando la Sua Privacy

Non vogliamo i Suoi dati. Non vendiamo annunci. Vogliamo solo aiutarLa a viaggiare meglio.

[Vedi tutte le caratteristiche](https://traveldocumentvault.com/it/features/) [Non è sicuro? Scopri perché le famiglie stanno scegliendo Travel Document Vault →](https://traveldocumentvault.com/it/why-us/)

## Prezzi Semplici e Onesti

Acquisto unico. Nessun abbonamento. Nessun costo nascosto. Nessun raccolta di dati.
...
- Pianificatore di viaggio con semaforo di disponibilità familiare
- Backup Vostro Cloud (iCloud o Google Drive, crittografia end-to-end)
- Tracker giorni all'estero per i giorni fiscali e i limiti di visto
- Limiti di giorni per paese per ogni membro della famiglia
- Ogni membro della famiglia, un caveau
- **Documenti** illimitati
- Dashboard di scadenza completo della famiglia
- Documenti multipagina (fino a 10 pagine)
- Tempo di promemoria personalizzato
- Esportazione PDF combinata per la stampa
- Esportazione batch di documenti

### Gratuito

Tutto ciò di cui ha bisogno per i viaggi in solitario
...
Ripristina gli acquisti in qualsiasi momento con l'account App Store o Google Play che ha usato per l'acquisto.

[Dettagli completi sui prezzi e Domande Frequenti](https://traveldocumentvault.com/it/pricing/)
...
Configuri stasera. Lasci che l'app ricordi in modo che Lei non debba farlo.
