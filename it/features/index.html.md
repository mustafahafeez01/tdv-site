...
Acquisizione fronte/retro in un unico documento. Perfetto per patenti di guida, carte d'identità nazionali e badge aziendali.
...
Conserva carte d'imbarco e biglietti elettronici con promemoria con conto alla rovescia ultrafrequente.

### Importazione flessibile

Importa file PDF o immagini esistenti dalla Sua libreria fotografica. Le scansioni esistenti si importano senza problemi.

### Modifica Documenti Salvati

Hai cambiato idea dopo aver salvato? Apri qualsiasi documento in modalità Modifica per aggiungere nuove foto, rimuovere quelle vecchie, o ritagliare e ruotare. Il tuo archivio rimane accurato senza ricominciare da capo.

### Cerca e filtra

Trova qualsiasi documento all'istante per nome o tipo. Filtra per persona, tipo di documento o stato di scadenza.

### Note sui documenti

Pro

Aggiungi note private a qualsiasi documento. Conserva dettagli aggiuntivi, istruzioni o promemoria che non rientrano nei campi standard.

### Condividi con facilità

Pro

Ogni documento ha un pulsante di condivisione integrato. Esporta come PDF o condividi il file originale (foto o documento importato) tramite email, messaggistica o qualsiasi app.

### Voucher e biglietti d'ingresso

Pro

Conserva carte regalo, codici sconto, biglietti per eventi e pass per attrazioni. Ricevi promemoria di scadenza affinché i voucher non vadano sprecati. Importa PDF multipagina con Pro.
...
## Scansione di Precisione

### Assistenza di precisione

Le guide a schermo aiutano ad allineare i documenti con precisione. Modelli diversi per tipi di documento diversi:

- **Passaporto**: con linea centrale divisoria per pagine aperte
- **Carta d'identità**: cornice delle dimensioni di una carta di credito
- **Visto / Permesso**: guida A5 / mezza pagina per timbri e adesivi
- **Pagina intera**: guida A4 per e-visa, assicurazioni e biglietti

### Perfeziona ogni scansione

Perfeziona le acquisizioni con strumenti di modifica integrati:

- **Ruota**: incrementi di 90°
- **Anteprima zoom**: pizzica per verificare la nitidezza
- **Avvisi di risoluzione**: se l'immagine è troppo piccola
- **Cornice di ritaglio regolabile**: allineamento con guide visive
...
8 mesi 6 mesi 3 mesi 6 settimane 1 mese 2 settimane 1 settimana Scadenza +1 giorno +1 settimana

#### Promemoria per il visto

3 mesi 6 settimane 1 mese 2 settimane 1 settimana Giorno di scadenza +1 giorno +1 settimana
...
Visualizza documenti e promemoria filtrati per persona. Vedi solo ciò che è rilevante.

### Cambio rapido

Passa da un profilo all'altro con un tocco. Perfetto per gestire tutta la famiglia.

PRO

### Profili illimitati

Il piano gratuito include 1 profilo. Pro sblocca profili illimitati per tutta la famiglia.

Esperienza nativa

## Progettato per il Suo Dispositivo

### Modalità scura e chiara

Si adatta alle impostazioni di sistema. Splendido in entrambe le modalità.
...
Disponibile in oltre 40 lingue, così l'app sembra nativa ovunque Lei si trovi.
...
## I Suoi Dati, il Suo Dispositivo
...
Nessuna analisi. Nessuna pubblicità. Nessun SDK nascosto che raccoglie i dati.
...
Protegga il Suo archivio con un PIN. Disponibile per tutti gli utenti gratuitamente.

### Blocco biometrico

Sblocchi con Face ID o Touch ID invece del PIN. Gratuito per tutti gli utenti. Richiede prima la configurazione del PIN.
...
## Lavora in Modo Più Intelligente, Più Veloce

### Menu contestuale con pressione prolungata

Premi a lungo su qualsiasi scheda documento per accedere istantaneamente alle azioni rapide: Esporta PDF, Condividi originale o Elimina. Senza dover aprire prima il documento.
...
## Scarica gratis. Nessun abbonamento.

Configuralo stasera. Lascia che l'app ricordi al posto Suo.
