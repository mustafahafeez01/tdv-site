...
Alt du behøver at vide om Travel Document Vault.

![Hent på App Store](https://traveldocumentvault.com/assets/images/app-store-badge-black.svg)

![Hent det på Google Play](https://traveldocumentvault.com/assets/images/google-play-badge.svg) Engangskøb · Intet abonnement Gå til: Privatliv Funktioner Sikkerhedskopi Priser Fejlfinding Juridisk
...
Ja. Dit køb dækker alle opdateringer inden for den aktuelle overordnede version (v1.x), inklusive fejlrettelser, sikkerhedspatches og nye funktioner. Forbedringer drevet af brugerfeedback, som brugervenlighed og nye dokumenttyper, er en del af disse normale opdateringer. Hvis vi nogensinde udgiver en v2.0 med et væsentligt genopbygget funktionssæt, kan det være et separat køb, men vi ville give tidlige brugere forudgående varsel og fortrinsretspriser. De mennesker, der stoler på appen tidligt, er grunden til, at den bliver bedre, og det er noget, vi ikke tager for givet.
...
Appen er tilgængelig på over 40 sprog, inklusive fuld understøttelse af højre-til-venstre-skrift for arabisk, urdu og farsi. Dit telefons sprog registreres automatisk, og du kan ændre det når som helst i Indstillinger. Hvis noget virker mærkeligt på dit sprog, vil vi gerne høre det. Skriv til os på [support@traveldocumentvault.com](mailto:support@traveldocumentvault.com), og det vil direkte påvirke køreplanen.
...
Ja. Vault Export (krypteret .tdvault-sikkerhedskopifil) er gratis for alle. Appen opretter også automatiske lokale sikkerhedskopier på din enhed med få minutters mellemrum, uden beregning. Sky-sikkerhedskopiering til dit eget iCloud eller Google Drive er Pro-muligheden. Ingen sikkerhedskopierings-funktion låser dine data inde.
...
Kan I få adgang til mine dokumenter?

**Nej.** Dine dokumenter forlader aldrig din enhed. Der er ingen servere, ingen cloud-synkronisering og ingen uploads. Alt forbliver på din telefon, krypteret og privat.

Da dine data aldrig når vores servere, har vi ingen måde at få adgang til, se eller gendanne dine dokumenter. Dette er bevidst designet for at beskytte dit privatliv.

Er sikkerhedskopier også krypterede?

**Ja.** Appen opretter lokale automatiske sikkerhedskopier på din enhed (ikke systemsikkerhedskopier). Vault-eksporter (.tdvault-filer) er **adgangskodebeskyttede** med stærk kryptering. Du angiver en adgangskode ved eksport og skal bruge den til gendannelse. For at gendanne på en ny enhed bruges Vault Export eller Pro-Cloud Backup til dit eget iCloud eller Google Drive.
...
Påmindelser startes automatisk, tidssat efter dokumenttype. Et pas starter 8 måneder før udløb (fornyelse tager typisk 6-8 uger), derefter trappes ned gennem 6 måneder, 3 måneder, 6 uger, 1 måned, 2 uger og 1 uge, samt på selve udløbsdagen. Visa, nationale ID-kort og rejseforsikring starter 3 måneder før. Selv hvis du overser datoen, minder vi dig **dagen efter** og **en uge efter** udløb for at hjælpe dig med at påbegynde fornyelsen. Flybilletter får i stedet en strammere kalender (1 uge, 2 dage, 1 dag, 24 timer) og ingen påmindelser efter udløb, da flyet er afgået.
...
Appen gemmer alt på din enhed. Hvis du har iCloud (iOS) eller Google Backup (Android) aktiveret, er dine dokumenter allerede beskyttet via din enhedssikkerhedskopi. Pro-brugere kan eksportere en **adgangskodebeskyttet krypteret sikkerhedskopi** til opbevaring, og alle brugere kan **gendanne fra en sikkerhedskopi** til enhver tid via Indstillinger → Importer vault. Dette erstatter alle aktuelle data med sikkerhedskopiindholdet. Vi synkroniserer bevidst ikke til vores servere for at beskytte dit privatliv.

Kan jeg dele dokumenter med familiemedlemmer?

Appen bruger **profiler** til at organisere dokumenter efter familiemedlem, men alle data forbliver på din enhed. Der er ingen delt adgang eller synkronisering mellem enheder. Hvis du har brug for at dele et dokument, kan du eksportere det ved hjælp af systemets deleark og sende det via AirDrop, e-mail eller besked.
...
**Vigtigt: Glemt PIN:** Hvis du glemmer din PIN, er den eneste måde at genvinde adgang på at slette og geninstallere appen, hvilket **permanent sletter alle dine data**. For at beskytte dig selv:

- Eksporter en krypteret sikkerhedskopi **inden** aktivering af App-lås (Indstillinger → Eksporter vault)
- Gem din PIN et sikkert sted (f.eks. din enheds adgangskodeadministrator)
- Aktivér **biometrisk lås** (gratis for alle brugere), så du kan bruge Face ID, Touch ID eller fingeraftryk i stedet for at indtaste PIN
- Hvis du har enhedssikkerhedskopier (iCloud/Google) aktiveret, kan gendannelse fra en sikkerhedskopi gendanne dine data efter geninstallation
...
**Gratis-brugere:** Får intelligente standarder valgt efter dokumenttype. Pas starter 8 måneder før, visa og ID-kort 3 måneder før, billetter og bookinger en uge før, og hver enkelt trappes ned til udløbsdatoen.

**Pro-brugere:** Kan ændre startpunktet for ethvert dokument. Vælg 8 måneder, 6 måneder, 3 måneder, 6 uger, 1 måned, 2 uger, 1 uge eller udløbsdagen, og resten af påmindelserne udfyldes selv. Flybilletter har deres egne valgmuligheder: 1 uge, 2 dage, 1 dag eller 24 timer.

For at tilpasse påmindelser, tryk på et dokument → Rediger → Påmindelsessektion (kun Pro).
...
Tryk og hold på et dokumentkort på din liste for at åbne en hurtig handlingsmenu. Herfra kan du **Eksportere PDF**, **Dele originale** filer eller **Slette** dokumentet uden at åbne det først. Du vil mærke et let haptisk tryk, når menuen vises. Dette virker for alle brugere (Gratis og Pro).
...
Alle dokumentkort er automatisk farvekodet. **Grønt** betyder gyldigt, **gult** betyder udløbet nærmer sig, og **rødt** betyder udløbet eller udløber snart. Du kan se status for hele dit vault på et øjeblik uden at åbne et eneste dokument.

**Pro-brugere** kan gå videre: tilsidesæt farven pr. dokumenttype fra profilindstillingsfanen. Tildel en særegen farve til pas, visa eller en kategori, du ønsker at fremhæve. Dette stables oven på statusfarverne, så du altid ser både kategorien og hastegraden på én gang.

Kan jeg vedhæfte fotos til mine noter?

Ja. Noter og Vouchers understøtter flere billedvedhæftelser. Gratis brugere kan vedhæfte et billede pr. note. **Pro-brugere kan vedhæfte op til 10.** Vedhæft et foto af en bekræftelsesmail, en QR-kode, en bookingbekræftelse eller hvad som helst, der tilføjer kontekst. Hvert billede er krypteret på enheden, lige som resten af dit vault.

## Platform og kompatibilitet

Hvornår vil Android-versionen være tilgængelig?

**Android-versionen kommer i begyndelsen af 2026.** Vi er i øjeblikket i lukket test for at sikre, at den samme privatlivsfremmende oplevelse med lokal lagring fungerer perfekt på Android-enheder.

Android-versionen vil have funktionsparitet med iOS, herunder krypteret lokal lagring, OCR-scanning, udløbspåmindelser og alle Pro-funktioner (ubegrænsede profiler, batcheksport af dokumenter og brugerdefinerede påmindelsestider).
...
Hvordan får jeg en refusion?

Alle køb behandles via den respektive App Store. For refusioner skal du anmode herom via Apple eller Google. Tjek venligst din kvitteringsmail for vejledning om, hvordan du anmoder om refusion fra den butik, du downloadede appen fra.

## Fejlfinding

Jeg modtager ikke påmindelsesbeskeder

Kontrollér, at notifikationer er aktiveret for Travel Document Vault under din enheds Indstillinger → Notifikationer. Sørg også for, at du har tilføjet en udløbsdato til dit dokument. Påmindelser planlægges kun, når der er angivet en udløbsdato.

OCR registrerer ikke min udløbsdato

OCR fungerer bedst med god belysning og et fladt dokument. Prøv at justere vinklen eller lysforholdene. Hvis registreringen mislykkes, kan du altid indtaste udløbsdatoen manuelt. OCR er et hjælpeværktøj – det er beregnet til at hjælpe, ikke erstatte omhyggelig dataindtastning.
...
Sandsynligvis ikke. Dine data gemmes automatisk, når du tilføjer eller redigerer dokumenter. Et nedbrud bør ikke forårsage datatab. Genåbn appen og kontrollér dine dokumenter. Hvis du oplever problemer, er du velkommen til at kontakte os på support@traveldocumentvault.com.

## Konfiguration og gendannelse

Hvad er min gendannelseskode, og hvad sker der, hvis jeg mister den?

Din gendannelseskode er en 24-tegns adgangskode, der krypterer din skysicheringskopi.

Hvordan krypteres min skysicheringskopi?

Dit vault er krypteret fra ende til ende ved hjælp af AES-256-GCM på din enhed.

[Læs hele guiden →](https://traveldocumentvault.com/da/faq/backup-explained/)

Hvordan fungerer PIN, Face ID og gendannelseskode sammen?

Din PIN-kode er et dagligt lås. Face ID er en hurtig genvej til at låse op.

[Læs hele guiden →](https://traveldocumentvault.com/da/faq/recovery-code/)
...
Slettede elementer går til papirkurven i 30 dage.

## Juridisk & ansvarsfraskrivelser

Er denne app en erstatning for officielle dokumenter?

**Nej.** Travel Document Vault er udelukkende et personligt organiseringsværktøj. Det erstatter ikke officielle dokumenter, verificerer ikke ægthed og garanterer ikke overholdelse af immigrationskrav. Medbring altid dine originale dokumenter, når du rejser, og verificér kravene hos officielle myndighedskilder.

Hvad sker der, hvis jeg overser en deadline på grund af en påmindelsesfejl?
...
Vi er her for at hjælpe. Kontakt os, og vi vender tilbage hurtigst muligt.

[Kontakt support](mailto:support@traveldocumentvault.com)
