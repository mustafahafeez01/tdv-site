...
![forælder og barn ved en check-in-skranke, mens medarbejderen studerer et åbent, guldfarvet pas med vandskadede sider](https://traveldocumentvault.com/blog/damaged-passport-travel/cover.jpg)
...
- **Bekræft at ekspresordningen dækker skade.** At betale for den hurtigste løsning betyder ikke automatisk, at den gælder for et beskadiget dokument, så kontroller det først.
- **Planlæg at møde personligt op.** Et beskadiget pas kræver næsten altid, at nogen inspicerer det og tager det ud af omløb, hvilket en ansøgning med posten ikke kan klare.
- **Spørg, hvilket kontor der håndterer hastesager.** I mange lande er det ikke den samme skranke, der tager imod rutineansøgninger, så find ud af det, før du kører tværs gennem byen forgæves.
- **Medbring dokumentation for din rejse.** Bookingbekræftelser er det, der åbner for de hurtigere ordninger, så hav dem med i stedet for at love at sende dem senere.
...
Et tydeligt digitalt foto af dit pas hjælper her. Gem data-siden, forsiden og bagsiden, så du med det samme kan give dit pasnummer og dine identitetsoplysninger i stedet for at lede efter dem.
...
Skade omfatter vandskade, løbende blæk, iturevne eller manglende sider, kraftig krølning, beskadigede segl eller sikkerhedselementer, eller alt, der skjuler dine personlige oplysninger eller biometriske data. Almindelig slitage, som små rynker ved forsidens kant, er acceptabel. Tommelfingerreglen: kan du ikke læse dine oplysninger tydeligt, eller er sikkerhedselementerne kompromitteret, er det skade.
...
Kontakt din pasmyndighed med det samme i stedet for at vente og se, om det bliver værre. Dit lands officielle pasmyndigheds hjemmeside er stedet, hvor du finder de gældende regler, da sagsbehandlingstider og betingelser ændrer sig hen over året. Spørg specifikt, om ekspresordningen accepterer et beskadiget pas, da den hurtigste service ofte er forbeholdt simple fornyelser. Når erstatningen ikke når at blive klar før din rejse, så spørg din ambassade, om et nødrejsedokument er en mulighed i stedet.
...
Det afhænger af, hvor du befinder dig, og hvor tæt på din rejse du er, og de offentliggjorte sagsbehandlingstider ændrer sig hen over året, så kontroller det aktuelle tal på din pasmyndigheds egen side i stedet for at stole på et tal fra et andet sted. Hurtigere ordninger findes generelt, men de indsnævres, jo tættere du kommer på afrejsedatoen, og kræver som regel, at du møder personligt op med det beskadigede pas og dokumentation for rejsen. Start processen den dag, du opdager skaden.
