...
We run no servers that ever hold or can read your documents. Everything stays on your device. That's why we can offer a one-time price instead of endless subscriptions.
...
Trip readiness, visa and tax day-count features are assistive only - always verify with official sources.

## Why One-Time and Not a Subscription?

Many document apps charge a yearly subscription because their business model depends on recurring revenue. That's not how we're built. We run no servers that ever hold or can read your data. Your documents stay on your device. We have no ongoing server costs to pass on to you.

A one-time price is fair, sustainable, and honest. You pay once. We stop asking.

## What's Included Free, Forever

The free tier isn't a trial. It's a real, permanent tier with core features you'll actually use: one profile, 5 documents, expiry reminders, document sharing, biometric lock, and on-device encryption. If you're solo or just testing, free is all you need.

No time limits. No features that mysteriously disappear. No dark patterns pushing you to upgrade.
...
Download free. No account needed. Pay once if you want Pro. That's it.
