...
Alles wat u moet weten over Travel Document Vault.

![Download van de App Store](https://traveldocumentvault.com/assets/images/app-store-badge-black.svg)

![Download van Google Play](https://traveldocumentvault.com/assets/images/google-play-badge.svg) Eenmalige aankoop · Geen abonnement Spring naar: Privacy Functies Back-up Prijzen Probleemoplossing Juridisch
...
Ja. Uw aankoop dekt elke update binnen de huidige hoofdversie (v1.x), inclusief bugfixes, beveiligingspatches en nieuwe functies. Verbeteringen gedreven door gebruikersfeedback, zoals bruikbaarheidswijzigingen en nieuwe documenttypen, maken deel uit van die normale updates. Als we ooit een v2.0 met een grotendeels herbouwde functieset uitbrengen, kan dit een afzonderlijke aankoop zijn, maar we zouden vroege gebruikers vooraf waarschuwen en voorkeursprijs geven. Mensen die de app vroeg vertrouwen, zijn de reden waarom het beter wordt, en dat nemen we niet voor lief.
...
De app is beschikbaar in meer dan 40 talen, inclusief volledige ondersteuning van rechts naar links voor Arabisch, Urdu en Farsi. De taal van uw telefoon wordt automatisch gedetecteerd, en u kunt deze op elk moment wijzigen in Instellingen. Als iets vreemd klinkt in uw taal, willen we dat echt graag weten. Stuur ons een bericht op [support@traveldocumentvault.com](mailto:support@traveldocumentvault.com) en dit zal direct invloed hebben op de roadmap.
...
Ja. Vault Export (versleuteld .tdvault-back-upbestand) is gratis voor iedereen. De app maakt ook elke paar minuten automatisch lokale back-ups op uw apparaat, zonder kosten. Cloudback-up naar uw eigen iCloud of Google Drive is de Pro-optie. Geen enkele back-upfunctie vergrendelt uw gegevens.
...
Wat als iemand mijn telefoon steelt? Zijn mijn documenten beschermd?
...
Kunt u mijn documenten inzien?

**Nee.** Uw documenten verlaten uw apparaat nooit. Er zijn geen servers, geen cloudsynchronisatie en geen uploads. Alles blijft op uw telefoon, versleuteld en privé.

Omdat uw gegevens onze servers nooit bereiken, hebben we geen manier om uw documenten in te zien, te bekijken of te herstellen. Dit is bewust ontworpen om uw privacy te beschermen.

Zijn back-ups ook versleuteld?

**Ja.** Automatische back-ups worden versleuteld via het ingebouwde back-upsysteem van uw apparaat (iCloud/Google). Vault exports (.tdvault-bestanden) zijn **met een wachtwoord beveiligd** met sterke versleuteling. U stelt een wachtwoord in bij het exporteren en hebt het nodig om te herstellen.

Als u van een back-up herstelt, zullen uw documenten automatisch werken op uw nieuwe apparaat zonder dat u iets speciaals hoeft te doen.
...
Herinneringen starten vanzelf, afgestemd op het documenttype. Een paspoort ontvangt de eerste herinnering 8 maanden voor de vervaldatum (paspoortverlengingen duren doorgaans 6-8 weken), daarna volgen herinneringen op 6 maanden, 3 maanden, 6 weken, 1 maand, 2 weken en 1 week, en opnieuw op de vervaldatum. Visa's, nationale identiteitskaarten en reisverzekeringen starten 3 maanden van tevoren. Zelfs als u de datum mist, herinneren we u **de dag erna** en **een week erna** na de vervaldatum om u te helpen het verlengingsproces te starten. Vliegkaartjes krijgen een strakker schema (1 week, 2 dagen, 1 dag, 24 uur) en geen herinneringen na vervaldag, omdat de vlucht al is vertrokken.
...
De app gebruikt **profielen** om documenten per gezinslid te organiseren, maar alle gegevens blijven op uw apparaat. Er is geen gedeelde toegang of synchronisatie tussen apparaten. Als u een document wilt delen, kunt u het exporteren via het systeem-deelvenster en het verzenden via AirDrop, e-mail of berichten.
...
- Schakel **biometrische ontgrendeling** in (gratis voor alle gebruikers) zodat u Face ID, Touch ID of vingerafdruk kunt gebruiken in plaats van de PIN in te typen
...
**Gratis gebruikers:** Ontvangen slimme standaardinstellingen gebaseerd op het documenttype. Paspoorten starten 8 maanden van tevoren, visa's en identiteitskaarten 3 maanden van tevoren, tickets en reserveringen een week van tevoren, en elk daarvan loopt stapsgewijs af tot de vervaldatum.

**Pro-gebruikers:** Kunnen het startpunt voor elk document aanpassen. Kies 8 maanden, 6 maanden, 3 maanden, 6 weken, 1 maand, 2 weken, 1 week of vervaldatum, en de rest van het schema wordt automatisch ingevuld. Vliegkaartjes hebben hun eigen keuzes: 1 week, 2 dagen, 1 dag of 24 uur.

Tik op een willekeurig document → Bewerken → Sectie Herinneringen (alleen Pro) om herinneringen aan te passen.
...
Druk lang (ingedrukt houden) op een willekeurige documentkaart in uw lijst om een snelactiemenu te openen. Van daaruit kunt u **PDF exporteren**, **Origineel delen** of het document **Verwijderen** zonder het eerst te openen. U voelt een subtiele haptische tik wanneer het menu verschijnt. Dit werkt voor alle gebruikers (Gratis en Pro).
...
Alle documentkaarten zijn automatisch kleurgecodeerd. **Groen** betekent geldig, **oranje** betekent verloopdatum nadert, en **rood** betekent verlopen of zeer binnenkort verlopen. U kunt de status van uw hele kluis in één oogopslag zien zonder een enkel document te openen.

**Pro-gebruikers** kunnen verder gaan: negeer de kleur per documenttype vanuit het tabblad profielinstellingen. Wijs een onderscheidende kleur toe aan paspoorten, visa of een categorie die u wilt laten opvallen. Dit stapelt zich bovenop de statuskleuren, dus u ziet altijd zowel de categorie als de urgentie tegelijk.

Kan ik foto's aan mijn notities toevoegen?

Ja. Notities en Vouchers ondersteunen meerdere afbeeldingsbijlagen. Gratis gebruikers kunnen één afbeelding per notitie toevoegen. **Pro-gebruikers kunnen tot 10 toevoegen.** Voeg een foto van een bevestigingsmail, een QR-code, een boeking referentie of iets anders dat context toevoegt. Elke afbeelding is op het apparaat versleuteld, net als de rest van uw kluis.

## Platform & Compatibiliteit

Wanneer is de Android-versie beschikbaar?
...
Alle aankopen worden verwerkt via de betreffende App Store. Voor terugbetalingen dient u een verzoek in bij Apple of Google. Controleer de bevestigingse-mail van uw aankoop voor instructies over het aanvragen van een terugbetaling bij de winkel waar u de app heeft gedownload.

## Probleemoplossing

Ik ontvang geen herinneringsmeldingen

Controleer of meldingen zijn ingeschakeld voor Travel Document Vault in uw apparaatinstellingen → Meldingen. Zorg ook dat u een vervaldatum heeft toegevoegd aan uw document. Herinneringen worden alleen gepland als er een vervaldatum is.

OCR detecteert mijn vervaldatum niet

OCR werkt het beste bij goede belichting en een vlak document. Probeer de hoek of belichting aan te passen. Als detectie mislukt, kunt u altijd de vervaldatum handmatig invoeren. OCR is ondersteunend. Het is ontworpen om te helpen, niet om zorgvuldige gegevensinvoer te vervangen.
...
Waarschijnlijk niet. Uw gegevens worden automatisch opgeslagen wanneer u documenten toevoegt of bewerkt. Een crash zou geen gegevensverlies mogen veroorzaken. Open de app opnieuw en controleer uw documenten. Als u problemen ziet, neem dan contact met ons op via support@traveldocumentvault.com.

## Instelling en herstel

Wat is mijn herstelcode en wat gebeurt er als ik deze verlies?

Uw herstelcode is een 24-karakters wachtwoordzin die uw cloudbacking versleutelt. Als u deze verliest, worden die back-ups onherstelbaar. We bewaren of resetten deze niet. Voor volledige details over wat dit betekent, waarom we het op deze manier ontwerpen en wat u moet doen als u het bent vergeten, raadpleegt u de handleiding voor herstelcode.

[Lees volledige gids →](https://traveldocumentvault.com/nl/faq/recovery-code/)
...
Is deze app een vervanging voor officiële documenten?

**Nee.** Travel Document Vault is uitsluitend een persoonlijk organisatiehulpmiddel. Het vervangt geen officiële documenten, verifieert geen authenticiteit en garandeert geen naleving van immigratievereisten. Neem altijd uw originele documenten mee bij het reizen en controleer de vereisten bij officiële overheidsinstanties.

Wat als ik een deadline mis vanwege een herinnering die niet werkte?
...
We zijn er om te helpen. Neem contact op en we reageren zo snel mogelijk.

[Contact opnemen](mailto:support@traveldocumentvault.com)
