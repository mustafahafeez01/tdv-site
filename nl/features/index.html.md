...
![Download van Google Play](https://traveldocumentvault.com/assets/images/google-play-badge.svg) Eenmalig betalen. Alle v1.x-updates inbegrepen, voor altijd.
...
Voor- en achterkant vastleggen in één document. Perfect voor rijbewijzen, nationale id's en werkinsignes.
...
Sla instapkaarten en e-kaartjes op met veelvuldige afteltijdherinneringen.
...
Van gedachten veranderd na het opslaan? Open een document in de bewerkingsmodus om nieuwe foto's toe te voegen, oude te verwijderen, of bij te snijden en te draaien. Uw kluis blijft actueel zonder opnieuw te beginnen.

### Zoeken & Filteren

Vind elk document direct op naam of type. Filter op persoon, documenttype of vervalstatus.

### Documentnotities

Pro

Voeg privénotities toe aan elk document. Sla extra details, instructies of herinneringen op die niet in standaardvelden passen.

### Makkelijk Delen

Pro

Elk document heeft een ingebouwde deelknop. Exporteer als PDF of deel het originele bestand (foto of geïmporteerd document) via e-mail, berichten of een andere app.

### Vouchers en Ingangskaartjes

Pro

Sla cadeaukaarten, kortingscodes, evenemententickets en attractiepassen op. Ontvang vervalherinneringen zodat vouchers niet worden verspild. Importeer meerdere PDF's met Pro.
...
Schermgidsen helpen u uw documenten nauwkeurig uit te lijnen. Verschillende sjablonen voor verschillende documenttypen:

- **Paspoort**: met middenverdeler voor open spreads
- **ID-kaart**: kader op creditcardformaat
- **Visum / Vergunning**: A5 / halve pagina gids voor stempels & stickers
- **Volledige Pagina**: A4-gids voor e-visa, verzekering & kaartjes

### Verfijn Elke Scan

Verfijn uw scans met ingebouwde bewerkingstools:

- **Draaien**: stappen van 90°
- **Zoomvoorvertoning**: knijp om scherpte te controleren
- **Resolutiewaarschuwingen**: als de afbeelding te klein is
- **Aanpasbaar bijsnijdkader**: uitlijnen met visuele gidsen
...
8 maanden 6 maanden 3 maanden 6 weken 1 maand 2 weken 1 week Vervaldatum +1 dag +1 week

#### Visumherinneringen

3 maanden 6 weken 1 maand 2 weken 1 week Vervaldatum +1 dag +1 week
...
Bekijk documenten en herinneringen gefilterd per persoon. Zie alleen wat relevant is.

### Snel Wisselen

Wissel met één tik tussen profielen. Perfect voor het beheren van het hele gezin.

### Onbeperkte Profielen

PRO

Gratis versie bevat 1 profiel. Pro ontgrendelt onbeperkte profielen voor het hele gezin.

Native Ervaring

## Gebouwd voor Jouw Apparaat

### Donkere en Lichte Modus

Past zich aan uw systeeminstellingen aan. Mooi in beide weergaven.
...
Beschikbaar in meer dan 40 talen, zodat de app zich native voelt waar je ook bent.
...
Geen analytics. Geen advertenties. Geen verborgen SDK's die uw gegevens verzamelen.
...
Bescherm uw kluis met een PIN. Beschikbaar voor alle gebruikers gratis.

### Biometrische Vergrendeling

Ontgrendel met Face ID of Touch ID in plaats van PIN. Gratis voor alle gebruikers. Vereist dat PIN eerst is ingesteld.
...
## Werk Slimmer, Sneller

### Contextmenu bij Lang Indrukken

Druk lang op een documentkaart voor direct toegang tot snelle acties: PDF exporteren, origineel delen of verwijderen. U hoeft het document niet eerst te openen.
...
## Gratis Downloaden. Geen Abonnement.

Stel het vanavond in. Laat de app onthouden zodat u dat niet hoeft.
