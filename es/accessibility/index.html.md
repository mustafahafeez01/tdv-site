# Funciones de Accesibilidad | Travel Document Vault

> Travel Document Vault está diseñado para todos. Compatible con VoiceOver, Texto Dinámico, Modo Oscuro y Reducir Movimiento, en una aplicación que funciona sin conexión y guarda sus documentos en su propio dispositivo.

Source: https://traveldocumentvault.com/es/accessibility/
...
- Indicadores de error con iconos X (no solo el color rojo)
...
La accesibilidad es un compromiso continuo. Si encuentra alguna dificultad al usar Travel Document Vault, o tiene sugerencias de mejora, no dude en comunicárnoslo.

[Enviar comentarios sobre accesibilidad](mailto:support@traveldocumentvault.com?subject=Accessibility%20Feedback)
