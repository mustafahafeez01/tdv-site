...
Todo lo que necesitas saber sobre Travel Document Vault.

![Descarga en App Store](https://traveldocumentvault.com/assets/images/app-store-badge-black.svg)

![Consíguelo en Google Play](https://traveldocumentvault.com/assets/images/google-play-badge.svg) Compra única · Sin suscripción Ir a: Privacidad Características Copia de Seguridad Precios Solución de Problemas Legal

## Confianza y Transparencia

¿Puede el desarrollador ver mis documentos?

No. Tus documentos se almacenan en tu dispositivo y nunca salen de él. No hay sistema de cuentas, no hay base de datos en la nube, y no hay servidor que reciba datos de documentos. La arquitectura fue diseñada de esta manera desde el principio, no agregada como una función posterior.
...
¿Qué incluye la actualización Pro de $9.99?

Pro es una **compra única** que desbloquea perfiles ilimitados, documentos ilimitados, exportación de PDF combinada, copia de seguridad cifrada, y tiempo de recordatorio personalizado. Pagas una sola vez - no hay suscripción, sin cargo recurrente, y sin prueba que comience a facturarte en silencio.

¿Están incluidas las actualizaciones futuras con mi compra?

Sí. Tu compra cubre todas las actualizaciones dentro de la versión principal actual (v1.x), incluyendo correcciones de errores, parches de seguridad, y nuevas características. Las mejoras impulsadas por retroalimentación de usuarios, como cambios de usabilidad y nuevos tipos de documentos, son parte de esas actualizaciones normales. Si alguna vez lanzamos v2.0 con un conjunto de características sustancialmente reconstruido, eso puede ser una compra separada, pero daríamos a los usuarios tempranos notificación previa y precios preferenciales. Las personas que confían en la aplicación temprano son la razón por la que mejora, y eso no es algo que damos por sentado.
...
Sí, completamente. La aplicación no tiene servidor y no necesita internet para funcionar. El escaneo, visualización, exportación, y recordatorios funcionan todos sin conexión. La única característica que requiere una conexión es restaurar tu compra Pro en un dispositivo nuevo a través de App Store o Google Play.

¿Qué idiomas soporta la aplicación?

La aplicación está disponible en más de 40 idiomas, incluida la compatibilidad completa de derecha a izquierda para árabe, urdu y farsi. El idioma de tu teléfono se detecta automáticamente y puedes cambiarlo en cualquier momento en Configuración. Si algo se ve mal en tu idioma, nos encantaría conocerlo. Envíanos un mensaje a [support@traveldocumentvault.com](mailto:support@traveldocumentvault.com) e influirá directamente en la hoja de ruta.
...
Travel Document Vault fue construida por [Mustafa Hafeez](https://traveldocumentvault.com/es/blog/why-i-built-travel-document-vault/), un desarrollador de software senior con años de experiencia profesional construyendo aplicaciones que respetan la privacidad, y un padre que necesitaba esta aplicación para su propia familia. La privacidad no es una línea de marketing. La aplicación fue diseñada y arquitecturada desde el primer día para que los documentos nunca salgan de tu dispositivo, no se necesiten cuentas, y no haya servidores involucrados. Esa es una decisión de ingeniería deliberada, no una política que pudiera cambiar con un interruptor de configuración.
...
La aplicación no tiene base de datos en la nube. No vemos tus datos. Si usas **iCloud Backup** (iOS) o **Google Backup** (Android) para todo tu teléfono, los datos de esta aplicación se incluyen en ese paquete. **Tus datos permanecen cifrados dentro de esas copias de seguridad.** Este proceso es gestionado por tu sistema operativo, no por nosotros.
...
Como no tenemos tus datos, no podemos restaurarlos para ti. Si restauras un nuevo teléfono desde una copia de seguridad del sistema (iCloud/Google), tus datos deberían reaparecer. Si no usas copias de seguridad del sistema, tus datos se pierden.

**Recomendación:** Usa la función Exportar para guardar una copia de tus documentos importantes en otro lugar.

¿Y si alguien roba mi teléfono? ¿Están protegidos mis documentos?
...
¿Puedes acceder a mis documentos?

**No.** Tus documentos nunca salen de tu dispositivo. No hay servidores, no hay sincronización en la nube, y sin cargas. Todo permanece en tu teléfono, cifrado y privado.

Porque tus datos nunca llegan a nuestros servidores, no tenemos forma de acceder, ver, o recuperar tus documentos. Esto es por diseño para proteger tu privacidad.

¿También están cifradas las copias de seguridad?

**Sí.** Las copias de seguridad automáticas están cifradas a través del sistema de copia de seguridad integrado de tu dispositivo (iCloud/Google). Las exportaciones de bóveda (archivos .tdvault) están **protegidas con contraseña** con cifrado fuerte. Establecerás una contraseña cuando exportes y la necesitarás para restaurar.

Si restauras desde una copia de seguridad, tus documentos funcionarán automáticamente en tu nuevo dispositivo sin que tengas que hacer nada especial.
...
Los recordatorios comienzan automáticamente, programados según el tipo de documento. Un pasaporte se activa 8 meses antes del vencimiento (las renovaciones de pasaportes típicamente toman 6-8 semanas), luego se reduce a 6 meses, 3 meses, 6 semanas, 1 mes, 2 semanas y 1 semana, y nuevamente en el día del vencimiento. Las visas, cédulas de identidad y seguros de viaje comienzan 3 meses antes. Incluso si pierdes la fecha, te recordaremos **el día después** y **una semana después** del vencimiento para ayudarte a iniciar la renovación. Los boletos aéreos tienen un cronograma más comprimido (1 semana, 2 días, 1 día, 24 horas) y sin recordatorios posteriores al vencimiento, ya que el vuelo ha despegado.
...
La aplicación almacena todo en tu dispositivo. Si tienes iCloud (iOS) o Google Backup (Android) habilitado, tus documentos ya están protegidos a través de tu copia de seguridad del dispositivo. Los usuarios Pro pueden exportar una **copia de seguridad cifrada protegida con contraseña** para guardar, y todos los usuarios pueden **restaurar desde una copia de seguridad** en cualquier momento a través de Configuración → Importar Bóveda. Esto reemplaza todos los datos actuales con el contenido de la copia de seguridad. Intencionalmente no sincronizamos a nuestros servidores para proteger tu privacidad.

¿Puedo compartir documentos con miembros de la familia?

La aplicación usa **perfiles** para organizar documentos por miembro de la familia, pero todos los datos permanecen en tu dispositivo. No hay acceso compartido o sincronización entre dispositivos. Si necesitas compartir un documento, puedes exportarlo usando la hoja de intercambio del sistema y enviarlo a través de AirDrop, correo electrónico, o mensajería.
...
**Importante: PIN Olvidado:** Si olvidas tu PIN, la única forma de recuperar acceso es eliminar e reinstalar la aplicación, lo que **elimina permanentemente todos tus datos**. Para protegerte:

- Exporta una copia de seguridad cifrada **antes de** habilitar Bloqueo de Aplicación (Configuración → Exportar Bóveda)
- Almacena tu PIN en algún lugar seguro (p.ej., el gestor de contraseñas de tu dispositivo)
- Habilita **desbloqueo biométrico** (gratuito para todos los usuarios) para que puedas usar Face ID, Touch ID, o huella en lugar de escribir el PIN
- Si tienes copias de seguridad de dispositivo (iCloud/Google) habilitadas, restaurar desde una copia de seguridad puede recuperar tus datos después de reinstalar
...
**Usuarios gratuitos:** Obtienen valores predeterminados inteligentes elegidos según el tipo de documento. Los pasaportes comienzan 8 meses antes, las visas y cédulas de identidad 3 meses antes, los boletos y reservas una semana antes, y cada uno se reduce automáticamente hasta el vencimiento.

**Usuarios Pro:** Pueden cambiar el punto de partida para cualquier documento. Elige 8 meses, 6 meses, 3 meses, 6 semanas, 1 mes, 2 semanas, 1 semana o día del vencimiento, y el resto del cronograma se completa automáticamente. Los boletos aéreos tienen sus propias opciones: 1 semana, 2 días, 1 día o 24 horas.

Para personalizar recordatorios, toca cualquier documento → Editar → sección Recordatorios (Solo Pro).
...
Presiona largo (presiona y mantén) cualquier tarjeta de documento en tu lista para abrir un menú de acciones rápidas. Desde allí puedes **Exportar PDF**, **Compartir Original**, o **Eliminar** el documento sin abrirlo primero. Sentirás un toque háptico sutil cuando el menú aparezca. Esto funciona para todos los usuarios (Gratuito y Pro).
...
Cada tarjeta de documento está codificada automáticamente por color. **Verde** significa válida, **ámbar** significa que el vencimiento se acerca, y **rojo** significa vencido o vencimiento inminente. Puedes ver el estado de toda tu bóveda de un vistazo sin abrir un solo documento.

Los **usuarios Pro** pueden ir más allá: anular el color en una base por tipo de documento desde la pestaña de configuración de perfil. Asigna un color distinto a pasaportes, visas, o cualquier categoría que quieras que destaque. Esto se suma a los colores de estado, así que siempre ves tanto la categoría como la urgencia a la vez.

¿Puedo adjuntar fotos a mis notas?

Sí. Las notas y los comprobantes admiten múltiples adjuntos de imagen. Los usuarios gratuitos pueden adjuntar una imagen por nota. Los **usuarios Pro pueden adjuntar hasta 10.** Adjunta una foto de un correo de confirmación, un código QR, una referencia de reserva, o cualquier cosa que agregue contexto. Cada imagen está cifrada en el dispositivo, exactamente como el resto de tu bóveda.

## Plataforma y Compatibilidad

¿Cuándo estará disponible la versión de Android?
...
¿Qué significa "todas las actualizaciones v1.x incluidas"?

Tu compra de $9.99 cubre cada actualización dentro de la versión principal actual, eso significa todas las correcciones de errores, parches de seguridad, y nuevas características lanzadas como v1.1, v1.2, v1.3, y así sucesivamente. Tu aplicación sigue funcionando y mejorando sin costo extra.

Si una futura versión principal (v2.0) es lanzada alguna vez con un conjunto de características significativamente reconstruido, eso puede ser ofrecido como una compra separada. Nunca serías forzado a actualizar, tu versión actual sigue funcionando exactamente como lo hace hoy. Ver nuestra [política de versiones completa](https://traveldocumentvault.com/pricing-policy/#version-policy) para detalles.

¿Cómo obtengo un reembolso?

Todas las compras se procesan a través de la respectiva App Store. Para reembolsos, necesitarás solicitar uno a través de Apple o Google. Por favor, verifica tu correo de recepción de compra para instrucciones sobre cómo solicitar un reembolso de la tienda donde descargaste la aplicación.

## Solución de Problemas

No estoy recibiendo notificaciones de recordatorio

Verifica que las notificaciones estén habilitadas para Travel Document Vault en tu Configuración → Notificaciones. También asegúrate de haber agregado una fecha de vencimiento a tu documento. Los recordatorios solo se programan cuando hay una fecha de vencimiento.

OCR no está detectando mi fecha de vencimiento

OCR funciona mejor con buena iluminación y un documento plano. Intenta ajustar el ángulo o la iluminación. Si la detección falla, siempre puedes entrar la fecha de vencimiento manualmente. OCR es asistivo. Está diseñado para ayudar, no reemplazar entrada de datos cuidadosa.
...
Probablemente no. Tus datos se guardan automáticamente cuando agregas o editas documentos. Un bloqueo no debería causar pérdida de datos. Reabre la aplicación y verifica tus documentos. Si estás viendo problemas, por favor contactanos en support@traveldocumentvault.com.
...
¿Es esta aplicación un reemplazo para documentos oficiales?

**No.** Travel Document Vault es una herramienta de organización personal solo. No reemplaza documentos oficiales, verifica autenticidad, o garantiza cumplimiento con ningún requisito de inmigración. Siempre lleva tus documentos originales cuando viajes y verifica requisitos con fuentes gubernamentales oficiales.

¿Y si pierdo un plazo por falla de recordatorio?
...
Estamos aquí para ayudar. Alcánzanos y te responderemos lo antes posible.

[Contactar Soporte](mailto:support@traveldocumentvault.com)
