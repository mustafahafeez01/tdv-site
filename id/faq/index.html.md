...
Semua yang perlu Anda ketahui tentang Travel Document Vault.

![Unduh di App Store](https://traveldocumentvault.com/assets/images/app-store-badge-black.svg)

![Dapatkan di Google Play](https://traveldocumentvault.com/assets/images/google-play-badge.svg) Pembelian satu kali · Tanpa langganan Lompat ke: Privasi Fitur Cadangan Harga Pemecahan Masalah Hukum
...
Ya. Pembelian Anda mencakup setiap pembaruan dalam versi mayor saat ini (v1.x), termasuk perbaikan bug, patch keamanan, dan fitur baru. Peningkatan yang didorong oleh umpan balik pengguna adalah bagian dari pembaruan normal tersebut. Jika kami pernah merilis v2.0 dengan set fitur yang dibangun ulang secara substansial, itu mungkin merupakan pembelian terpisah, tetapi kami akan memberi pengguna awal pemberitahuan awal dan harga preferensial. Orang-orang yang mempercayai aplikasi lebih awal adalah alasan mengapa aplikasi menjadi lebih baik, dan itu bukan sesuatu yang kami anggap remeh.
...
Aplikasi tersedia dalam lebih dari 40 bahasa, termasuk dukungan penuh kanan-ke-kiri untuk bahasa Arab, Urdu, dan Persia. Bahasa ponsel Anda terdeteksi secara otomatis, dan Anda dapat mengubahnya kapan saja di Pengaturan. Jika ada yang terdengar aneh dalam bahasa Anda, kami benar-benar ingin tahu. Hubungi kami di [support@traveldocumentvault.com](mailto:support@traveldocumentvault.com), dan itu akan langsung mempengaruhi roadmap kami.
...
Bagaimana jika seseorang mencuri ponsel saya? Apakah dokumen saya terlindungi?
...
Bisakah Anda mengakses dokumen saya?

**Tidak.** Dokumen Anda tidak pernah meninggalkan perangkat Anda. Tidak ada server, tidak ada sinkronisasi cloud, dan tidak ada unggahan. Semuanya tetap di ponsel Anda, terenkripsi dan privat.

Karena data Anda tidak pernah mencapai server kami, kami tidak memiliki cara untuk mengakses, melihat, atau memulihkan dokumen Anda. Ini dirancang untuk melindungi privasi Anda.

Apakah cadangan juga dienkripsi?

**Ya.** Cadangan otomatis dienkripsi melalui sistem cadangan bawaan perangkat Anda (iCloud/Google). Ekspor Vault (.tdvault) **dilindungi kata sandi** dengan enkripsi yang kuat. Anda akan menetapkan kata sandi saat mengekspor dan membutuhkannya untuk memulihkan.

Jika Anda memulihkan dari cadangan, dokumen Anda akan otomatis bekerja di perangkat baru Anda tanpa perlu melakukan apa pun yang istimewa.
...
Pengingat dimulai secara otomatis, dijadwalkan sesuai jenis dokumen. Paspor dimulai 8 bulan sebelum kedaluwarsa (pembaruan paspor biasanya membutuhkan 6-8 minggu), kemudian menurun melalui 6 bulan, 3 bulan, 6 minggu, 1 bulan, 2 minggu dan 1 minggu, dan sekali lagi pada hari kedaluwarsa. Visa, KTP Nasional, dan asuransi perjalanan dimulai 3 bulan sebelumnya. Bahkan jika Anda melewatkan tanggalnya, kami akan mengingatkan Anda **sehari setelah** dan **satu minggu setelah** kedaluwarsa untuk membantu Anda memulai pembaruan. Tiket pesawat mendapatkan jadwal yang lebih ketat sebaliknya (1 minggu, 2 hari, 1 hari, 24 jam) dan tanpa pengingat pasca-kedaluwarsa, karena penerbangan sudah berangkat.
...
Bisakah saya menyesuaikan waktu pengingat?

**Pengguna gratis:** Dapatkan pengaturan default cerdas yang dipilih berdasarkan jenis dokumen. Paspor dimulai 8 bulan sebelumnya, visa dan KTP 3 bulan sebelumnya, tiket dan pemesanan seminggu sebelumnya, dan masing-masing secara otomatis menurun hingga tanggal kedaluwarsa.

**Pengguna Pro:** Dapat mengubah titik awal untuk dokumen apa pun. Pilih 8 bulan, 6 bulan, 3 bulan, 6 minggu, 1 bulan, 2 minggu, 1 minggu atau hari kedaluwarsa, dan jadwal sisanya akan terisi secara otomatis dari sana. Tiket pesawat memiliki pilihan tersendiri: 1 minggu, 2 hari, 1 hari atau 24 jam.

Untuk menyesuaikan pengingat, ketuk dokumen mana saja → Edit → bagian Pengingat (hanya Pro).
...
Tekan lama (tekan dan tahan) kartu dokumen mana pun di daftar Anda untuk membuka menu tindakan cepat. Dari sana Anda dapat **Ekspor PDF**, **Bagikan Asli**, atau **Hapus** dokumen tanpa membukanya terlebih dahulu. Anda akan merasakan ketukan haptic halus saat menu muncul. Ini bekerja untuk semua pengguna (Gratis dan Pro).
...
Setiap kartu dokumen dikodekan warna secara otomatis. **Hijau** berarti valid, **amber** berarti kedaluwarsa sudah dekat, dan **merah** berarti kedaluwarsa atau kedaluwarsa segera. Anda dapat melihat status seluruh vault Anda dalam sekejap tanpa membuka satu dokumen pun.

**Pengguna Pro** dapat melangkah lebih jauh: ganti warna per jenis dokumen dari tab pengaturan profil. Tetapkan warna yang berbeda untuk paspor, visa, atau kategori apa pun yang ingin Anda tonjolkan. Ini menumpuk di atas warna status, jadi Anda selalu melihat kategori dan urgensi sekaligus.

Bisakah saya melampirkan foto ke catatan saya?

Ya. Catatan dan Voucher mendukung beberapa lampiran gambar. Pengguna gratis dapat melampirkan satu gambar per catatan. **Pengguna Pro dapat melampirkan hingga 10.** Lampirkan foto email konfirmasi, kode QR, referensi pemesanan, atau apa pun yang menambah konteks. Setiap gambar dienkripsi di perangkat, seperti sisa vault Anda.
...
**Ya.** Pro adalah pembelian satu kali untuk **versi mayor saat ini** (v1.x). Anda akan menerima semua perbaikan bug, pembaruan keamanan, dan penambahan fitur secara gratis dalam versi tersebut.

Jika kami merilis versi mayor 2.0 di masa mendatang dengan fitur baru yang signifikan, itu mungkin memerlukan pembelian upgrade terpisah. Kami akan memberi pemberitahuan awal dan harga early-bird kepada pengguna Pro yang sudah ada.

Pelajari selengkapnya di [Kebijakan Harga](https://traveldocumentvault.com/pricing-policy/) kami.
...
Semua pembelian diproses melalui App Store masing-masing. Untuk pengembalian dana, Anda perlu memintanya melalui Apple atau Google. Silakan periksa email tanda terima pembelian Anda untuk petunjuk tentang cara meminta pengembalian dana dari toko tempat Anda mengunduh aplikasi.

## Pemecahan Masalah

Saya tidak menerima notifikasi pengingat

Periksa bahwa notifikasi diaktifkan untuk Travel Document Vault di Pengaturan perangkat Anda → Notifikasi. Pastikan juga Anda telah menambahkan tanggal kedaluwarsa ke dokumen Anda. Pengingat hanya dijadwalkan ketika ada tanggal kedaluwarsa.

OCR tidak mendeteksi tanggal kedaluwarsa saya

OCR bekerja paling baik dengan pencahayaan yang baik dan dokumen yang rata. Coba sesuaikan sudut atau pencahayaan. Jika deteksi gagal, Anda selalu dapat memasukkan tanggal kedaluwarsa secara manual. OCR bersifat bantuan. Ini dirancang untuk membantu, bukan menggantikan entri data yang cermat.
...
Kemungkinan tidak. Data Anda disimpan secara otomatis saat Anda menambahkan atau mengedit dokumen. Kerusakan seharusnya tidak menyebabkan kehilangan data. Buka kembali aplikasi dan periksa dokumen Anda. Jika Anda melihat masalah, silakan hubungi kami di support@traveldocumentvault.com.
...
Brankas Anda dienkripsi ujung ke ujung menggunakan AES-256-GCM di perangkat Anda.

[Baca panduan lengkap →](https://traveldocumentvault.com/id/faq/backup-explained/)

Bagaimana PIN, Face ID, dan kode pemulihan bekerja bersama?

PIN Anda adalah kunci harian. Face ID adalah jalan pintas cepat untuk membuka kunci.

[Baca panduan lengkap →](https://traveldocumentvault.com/id/faq/recovery-code/)
...
Item yang dihapus masuk ke tempat sampah selama 30 hari.

## Hukum & Penafian

Apakah aplikasi ini menggantikan dokumen resmi?

**Tidak.** Travel Document Vault hanyalah alat organisasi pribadi untuk menyimpan salinan digital dokumen Anda. **Salinan digital yang disimpan dalam aplikasi ini TIDAK berlaku untuk perjalanan.** Ini tidak menggantikan dokumen resmi, memverifikasi keaslian, atau menjamin kepatuhan dengan persyaratan imigrasi apa pun. Selalu bawa dokumen asli Anda saat bepergian dan verifikasi persyaratan dengan sumber pemerintah resmi.

Bagaimana jika saya melewatkan tenggat waktu karena kegagalan pengingat?
...
Kami siap membantu. Hubungi kami dan kami akan segera merespons.

[Hubungi Dukungan](mailto:support@traveldocumentvault.com)
