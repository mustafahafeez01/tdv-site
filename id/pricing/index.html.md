...
> Travel Document Vault berharga $9.99 sekali saja. Tanpa langganan, tanpa biaya tersembunyi. Satu pembelian untuk seluruh keluarga. Versi gratis tersedia.
...
- Paspor, visa, SIM & lainnya
- Pindai dokumen, tanggal diisi otomatis
- Pengingat kedaluwarsa
- Bagikan dokumen individual
- Kunci PIN + Biometrik (Face ID / Touch ID)
- 1 profil
- Hingga 5 dokumen
- Baru-baru ini dihapus - jendela pembatalan 30 hari

Semua data tetap berada di perangkat Anda. Selalu.
...
- Cadangan Cloud Anda Sendiri (iCloud atau Google Drive, terenkripsi ujung-ke-ujung)
- Pelacak hari-hari di luar negeri untuk batas pajak dan visa
- Tunjangan batas hari per negara untuk setiap anggota keluarga
- Setiap anggota keluarga, satu brankas
- **Dokumen** tak terbatas
- Dasbor kedaluwarsa keluarga penuh
...
$9.99 satu kali Untuk seluruh keluarga Anda. Bayar sekali. Semua pembaruan v1.x disertakan, selamanya.

[Tentang kebijakan versi kami →](https://traveldocumentvault.com/pricing-policy/#version-policy)

Semua yang ada di Gratis, plus:
...
Banyak aplikasi dokumen mengenakan langganan tahunan karena model bisnis mereka bergantung pada pendapatan berulang. Kami tidak dibangun seperti itu. Kami tidak menjalankan server yang pernah menyimpan atau dapat membaca data Anda. Dokumen Anda tetap berada di perangkat Anda. Kami tidak memiliki biaya server yang berkelanjutan untuk diteruskan kepada Anda.

Harga satu kali adalah wajar, berkelanjutan, dan jujur. Anda membayar sekali. Kami berhenti bertanya.

## Apa yang Disertakan Gratis, Selamanya

Tingkat gratis bukan uji coba. Ini adalah tingkat permanen nyata dengan fitur inti yang benar-benar akan Anda gunakan: satu profil, 5 dokumen, pengingat kedaluwarsa, berbagi dokumen, kunci biometrik, dan enkripsi di perangkat. Jika Anda solo atau hanya menguji, gratis adalah semua yang Anda butuhkan.

Tidak ada batas waktu. Tidak ada fitur yang misterius menghilang. Tidak ada pola gelap yang mendorong Anda untuk upgrade.
