...
Tudo o que precisa saber sobre o Travel Document Vault.

![Descarregue na App Store](https://traveldocumentvault.com/assets/images/app-store-badge-black.svg)

![Obtenha no Google Play](https://traveldocumentvault.com/assets/images/google-play-badge.svg) Compra única · Sem subscrição Ir para: Privacidade Funcionalidades Cópia de Segurança Preços Resolução de Problemas Aspetos Legais
...
Sim. A sua compra cobre todas as atualizações dentro da versão principal atual (v1.x), incluindo correções de erros, patches de segurança e novas funcionalidades. Melhorias impulsionadas pelo feedback dos utilizadores são parte dessas atualizações normais. Se lançarmos uma v2.0 com funcionalidades substancialmente reconstruídas, poderá ser uma compra separada, mas daríamos aviso prévio aos primeiros adotantes e preços preferenciais.
...
A aplicação está disponível em mais de 40 idiomas, incluindo suporte completo de direita para esquerda para árabe, urdu e farsi. A língua do seu telefone é detectada automaticamente e pode alterá-la em qualquer altura nas Definições. Se algo parece estranho na sua língua, gostaríamos genuinamente de saber. Envie-nos uma mensagem para [support@traveldocumentvault.com](mailto:support@traveldocumentvault.com) e isso influenciará diretamente o nosso plano.
...
A aplicação não tem base de dados na nuvem. Não vemos os seus dados. Se usar **iCloud Backup** (iOS) ou **Google Backup** (Android) para o seu telemóvel inteiro, os dados desta aplicação estão incluídos nesse pacote. **Os seus dados permanecem encriptados nessas cópias de segurança.** Este processo é gerido pelo seu sistema operativo, não por nós.
...
Podem aceder aos meus documentos?

**Não.** Os seus documentos nunca saem do seu dispositivo. Não há servidores, sincronização na nuvem nem carregamentos. Tudo fica no seu telemóvel, encriptado e privado.

Como os seus dados nunca chegam aos nossos servidores, não temos forma de aceder, ver ou recuperar os seus documentos. Isso é intencional para proteger a sua privacidade.

As cópias de segurança também estão encriptadas?

**Sim.** As cópias de segurança automáticas são encriptadas através do sistema de cópia de segurança integrado do seu dispositivo (iCloud/Google). As exportações do cofre (ficheiros .tdvault) são **protegidas por palavra-passe** com encriptação forte. Definirá uma palavra-passe ao exportar e precisará dela para restaurar.

Se restaurar a partir de uma cópia de segurança, os seus documentos funcionarão automaticamente no seu novo dispositivo sem precisar de fazer nada de especial.
...
Os lembretes começam automaticamente, conforme o tipo de documento. Um passaporte começa 8 meses antes da expiração (a renovação leva normalmente 6-8 semanas), depois continua com lembretes aos 6 meses, 3 meses, 6 semanas, 1 mês, 2 semanas e 1 semana, e novamente no dia de expiração. Vistos, bilhetes de identidade e seguros de viagem começam 3 meses antes. Mesmo que perca o prazo, lembramos-lhe **no dia seguinte** e **uma semana após** a expiração para ajudar a iniciar a renovação. Os bilhetes de avião têm um cronograma mais curto em alternativa (1 semana, 2 dias, 1 dia, 24 horas) e nenhum lembrete após expiração, pois o voo já partiu.
...
A aplicação armazena tudo no seu dispositivo. Se tiver o iCloud (iOS) ou Google Backup (Android) ativado, os seus documentos já estão protegidos através da cópia de segurança do dispositivo. Os utilizadores Pro podem exportar uma **cópia de segurança encriptada protegida por palavra-passe** para guardar em segurança, e todos os utilizadores podem **restaurar a partir de uma cópia de segurança** a qualquer momento em Definições → Importar Cofre. Isso substitui todos os dados atuais pelo conteúdo da cópia de segurança. Intencionalmente não sincronizamos com os nossos servidores para proteger a sua privacidade.

Posso partilhar documentos com membros da família?

A aplicação usa **perfis** para organizar documentos por membro da família, mas todos os dados ficam no seu dispositivo. Não há acesso partilhado nem sincronização entre dispositivos. Se precisar de partilhar um documento, pode exportá-lo usando o menu de partilha do sistema e enviá-lo por AirDrop, e-mail ou mensagens.
...
- Ative o **desbloqueio biométrico** (gratuito para todos os utilizadores) para poder usar Face ID, Touch ID ou impressão digital em vez de digitar o PIN
- Se tiver cópias de segurança do dispositivo (iCloud/Google) ativadas, restaurar a partir de uma cópia de segurança poderá recuperar os seus dados após reinstalar
...
O que significa 'Última cópia de segurança: há 2 horas, 12 documentos' nas Definições?

Esta linha indica quando foi criada a sua última cópia de segurança local automática e quantos documentos contém. A aplicação guarda automaticamente uma cópia de segurança local no seu dispositivo **a cada poucos minutos** enquanto a utiliza. Estas cópias ficam no seu dispositivo e são independentes da cópia de segurança na nuvem do Pro. Se precisar de restaurar, vá às **Definições** e escolha a cópia de segurança pretendida.
...
**Utilizadores gratuitos:** Recebem lembretes inteligentes predefinidos conforme o tipo de documento. Passaportes começam 8 meses antes, vistos e bilhetes de identidade 3 meses antes, bilhetes e reservas uma semana antes, e cada um continua até à data de expiração.

**Utilizadores Pro:** Podem alterar quando começam os lembretes para qualquer documento. Escolha 8 meses, 6 meses, 3 meses, 6 semanas, 1 mês, 2 semanas, 1 semana ou dia de expiração, e o restante cronograma preenche-se automaticamente. Os bilhetes de avião têm as suas próprias opções: 1 semana, 2 dias, 1 dia ou 24 horas.

Para personalizar lembretes, toque em qualquer documento → Editar → secção Lembretes (apenas Pro).
...
Mantenha pressionado qualquer cartão de documento na sua lista para abrir um menu de ações rápidas. A partir daí pode **Exportar PDF**, **Partilhar Original** ou **Eliminar** o documento sem o abrir primeiro. Sentirá um leve toque háptico quando o menu aparecer. Funciona para todos os utilizadores (Gratuito e Pro).
...
Cada cartão de documento é codificado automaticamente por cor. **Verde** significa válido, **âmbar** significa que a validade está a aproximar-se e **vermelho** significa expirado ou expiração iminente. Pode ver o estado do seu cofre inteiro num relance sem abrir um único documento.

Os **utilizadores Pro** podem ir mais longe: anular a cor numa base por tipo de documento a partir do separador de definições de perfil. Atribua uma cor distinta a passaportes, vistos ou qualquer categoria que queira que se destaque. Isto acumula-se nas cores de estado, por isso vê sempre tanto a categoria como a urgência ao mesmo tempo.

Posso anexar fotos aos meus apontamentos?

Sim. Apontamentos e Comprovantes suportam múltiplos anexos de imagem. Utilizadores gratuitos podem anexar uma imagem por apontamento. **Os utilizadores Pro podem anexar até 10.** Anexe uma foto de um e-mail de confirmação, um código QR, uma referência de reserva ou qualquer outra coisa que adicione contexto. Cada imagem é encriptada no dispositivo, exactamente como o resto do seu cofre.

## Plataforma e Compatibilidade

Quando estará disponível a versão Android?

**A versão Android chegará no início de 2026.** Estamos atualmente em testes fechados para garantir que a mesma experiência com privacidade em primeiro lugar e armazenamento no dispositivo funciona perfeitamente em dispositivos Android.

A versão Android terá paridade de funcionalidades com iOS, incluindo armazenamento encriptado no dispositivo, digitalização OCR, lembretes de expiração e todas as funcionalidades Pro (perfis ilimitados, exportação em lote e tempos de lembretes personalizados).
...
Todas as compras são processadas através da respetiva App Store. Para reembolsos, terá de solicitar um através da Apple ou Google. Por favor, verifique o e-mail do recibo de compra para obter instruções sobre como solicitar um reembolso na loja onde descarregou a aplicação.

## Resolução de Problemas

Não estou a receber notificações de lembrete

Verifique se as notificações estão ativadas para o Travel Document Vault nas Definições do dispositivo → Notificações. Certifique-se também de que adicionou uma data de expiração ao seu documento. Os lembretes só são agendados quando existe uma data de expiração.

O OCR não está a detetar a minha data de expiração

O OCR funciona melhor com boa iluminação e um documento plano. Tente ajustar o ângulo ou a iluminação. Se a deteção falhar, pode sempre introduzir a data de expiração manualmente. O OCR é uma funcionalidade de apoio. Foi concebido para ajudar, não para substituir a introdução cuidadosa de dados.
...
Provavelmente não. Os seus dados são guardados automaticamente quando adiciona ou edita documentos. Um fecho inesperado não deve causar perda de dados. Reabra a aplicação e verifique os seus documentos. Se estiver a ter problemas, contacte-nos em support@traveldocumentvault.com.
...
Esta aplicação substitui os documentos oficiais?

**Não.** O Travel Document Vault é apenas uma ferramenta de organização pessoal. Não substitui documentos oficiais, não verifica a autenticidade nem garante a conformidade com quaisquer requisitos de imigração. Transporte sempre os seus documentos originais quando viajar e verifique os requisitos junto de fontes governamentais oficiais.

E se perder um prazo devido a uma falha de lembrete?
...
Estamos aqui para ajudar. Contacte-nos e responderemos o mais brevemente possível.

[Contactar Suporte](mailto:support@traveldocumentvault.com)
