...
![Um passaporte a sair parcialmente de um envelope creme simples num fundo azul-marinho profundo, sugerindo uma renovação em progresso](https://traveldocumentvault.com/blog/how-long-does-passport-renewal-take/cover.jpg)
...
**Uma ressalva importante: os tempos publicados são médias, não garantias.** Verifique em [travel.state.gov](https://travel.state.gov/content/travel/en/passports/how-apply/processing-times.html) os tempos atuais antes de se candidatar porque, durante procura de pico (janeiro a março e junho a agosto), o processamento de rotina regularmente estende-se bem além das estimativas publicadas. Se a sua viagem cai nos próximos 3 meses, considere pagar os extra 60 USD pelo processamento acelerado - o custo modesto é muito compensado pela certeza e flexibilidade de agendamento que fornece.
...
Os tempos de processamento padrão da Austrália são geralmente melhores do que os EUA e Reino Unido, mas ainda podem esticar-se durante períodos de pico. O Serviço de Passaportes Australiano recomenda candidatar-se pelo menos seis semanas antes de viajar se estiver a usar o padrão - consulte [passports.gov.au](https://www.passports.gov.au) para tempos atuais.
...
- **Formulários incorretos ou incompletos.** Um campo em falta envia a sua candidatura direita de volta. Leia as instruções uma vez, preencha o formulário, depois leia-as novamente antes de submeter.
- **Fotos não conformes.** As regras de fotos de passaporte são rígidas - cor de fundo, tamanho de cabeça, expressão, sem óculos. Fotos rejeitadas param o processamento a frio. Tire-as profissionalmente se não tiver certeza.
- **Documentos de apoio em falta.** Mudanças de nome, primeiras candidaturas de adultos e confirmações de cidadania precisam de documentação extra. Tenha tudo pronto antes de se candidatar, não depois.
- **Enviar pelo correio quando está com falta de tempo.** O correio é imprevisível. Se a sua viagem está próxima, use rotas presenciais ou aceleradas onde puder e não marque viagem antes de o novo passaporte chegar.

## Pode Viajar Enquanto o Seu Passaporte Está Sendo Renovado?

A resposta surpreende a maioria das pessoas. Na maioria dos países, pode viajar enquanto a renovação está pendente - usará o seu passaporte antigo (ainda válido) juntamente com documentação oficial da autoridade de passaportes confirmando que a sua candidatura está em progresso.

As regras variam por país:

- **Estados Unidos:** Pode viajar com um passaporte válido enquanto a sua candidatura de renovação está pendente. Se submeteu o seu passaporte com a candidatura de renovação (obrigatório em alguns casos), não pode viajar até o receber de volta. Pergunte sobre a opção "acelerar devido a viagem" se tiver viagem iminente.
- **Reino Unido:** Pode viajar usando o seu passaporte antigo enquanto um novo está em progresso - desde que o antigo ainda seja válido. Assim que o enviar para HMPO, não pode usá-lo. Não envie o seu passaporte enquanto a viagem está iminente.
- **Austrália:** Princípio semelhante - o seu passaporte atual permanece válido e utilizável enquanto a renovação está processada, a menos que o tenha submetido fisicamente.
- **Canadá:** Pode viajar com um passaporte válido enquanto uma candidatura de renovação está pendente, desde que não tenha entregue o seu passaporte atual como parte do processo.
- **Nova Zelândia:** As candidaturas podem ser feitas sem entregar o seu passaporte atual na maioria dos casos - verifique a orientação do Department of Internal Affairs para a sua situação específica.
- **Irlanda:** Os serviços de renovação Passport Online e An Post não requerem que entregue o seu passaporte atual até o novo estar pronto. Verifique a orientação atual do Serviço de Passaporte antes de se candidatar.
...
1. **Contacte a sua autoridade de passaportes - não apenas veja o website.** Todos os quatro países têm disposições de marcações urgentes e de emergência. Uma chamada telefónica coloca-o em contacto com uma pessoa real que pode dizer-lhe exatamente o que está disponível.
2. **Reúna os seus documentos antes de contactar.** Precisará de prova de viagem iminente (confirmações de reserva mostrando datas), o seu passaporte atual, fotos e formulários preenchidos. Tenha tudo pronto - marcações urgentes movem-se rapidamente.
...
Os EUA oferecem um programa de renovação online para adultos elegíveis que receberam o seu passaporte aos 16 anos ou mais - verifique em [travel.state.gov](https://travel.state.gov) a elegibilidade atual. O Reino Unido oferece uma opção de renovação digital para adultos elegíveis que se candidatam dentro do Reino Unido - candidatos do exterior devem usar um serviço separado. Austrália e Canadá ambos requerem apresentação presencial para a maioria das renovações. Sempre verifique o website oficial do seu país para regras de elegibilidade atuais.
...
Na maioria dos casos, sim - desde que o seu passaporte atual ainda seja válido e não tenha submetido fisicamente como parte do processo de renovação. Os EUA, Reino Unido, Austrália, Canadá, Nova Zelândia e Irlanda permitem viajar com um passaporte atual válido enquanto uma candidatura de renovação está pendente. A exceção é se entregou o seu passaporte ao processo de candidatura, caso em que terá de esperar. Sempre verifique com a sua autoridade de passaportes específica e considere qualquer implicação de visto antes de viajar.

## Artigos Relacionados

[Regras de Passaporte7 min de leitura · 1 fev de 2026A Regra de Validade de 6 Meses do Passaporte: Quais Países a Aplicam](https://traveldocumentvault.com/pt/blog/passport-expiry-6-month-rule/)

[Organização7 min de leitura · 5 fev de 2026Como Organizar Documentos de Viagem Familiar (Antes da Sua Próxima Viagem)](https://traveldocumentvault.com/pt/blog/how-to-organise-family-travel-documents/)
