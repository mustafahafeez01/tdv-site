...
> Cópia de segurança encriptada de ponta a ponta no seu próprio iCloud ou Google Drive. Você guarda o código de recuperação. AES-256-GCM + PBKDF2 600k. Nunca acedemos. Acesso em qualquer dispositivo. Offline-first.
...
Várias camadas de segurança estão entre um toque acidental e dados perdidos.
...
A cópia de segurança nuvem é uma camada de segurança, mas nenhum sistema é perfeito. As contas nuvem podem ser perdidas, os códigos de recuperação podem ser esquecidos, os serviços de armazenamento de terceiros podem ter interrupções e podem ocorrer problemas de sincronização ou dados inesperados. Fornecemos cópia de segurança nuvem como uma conveniência, não como garantia.

Para documentos críticos, mantenha sempre uma cópia independente, tal como uma cópia em papel impressa num local seguro, exportação de cofre encriptado separada guardada noutro armazenamento, ou originais guardados fisicamente, e verifique que os seus documentos podem ser recuperados antes de precisar deles.
